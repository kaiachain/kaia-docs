...
本教程將逐步指導如何設置 ServiceChain 網絡並將其連接到 Kaia Kairos 網絡。您還將學習如何實現定期錨定和跨鏈價值轉移。為了利用 ServiceChain 運行實際的區塊鏈服務，我們將講解高可用性、分層構建 ServiceChain 以及同級 ServiceChain 之間的價值轉移。
