...
在[連接到 Kairos](en-scn-connection.md)中，我們假設 EN 和 SCN 分別以 EN-01 和 SCN-L2-01 的橋接方式連接。在本節中，我們將在 EN-02 和 SCN-L2-02 之間添加另一座橋樑。由於程序相同，我們將作簡要說明。
...
在 SCN-L2-02 的外殼上，按以下說明編輯 `kscn-XXXXX-amd64/conf/kscnd.conf`。要連接橋接器，請將 `SC_SUB_BRIDGE` 設置為 1。
