...
需要先安裝 [Python](https://www.python.org/downloads/) 3.7.2+
...
更多資訊請參考 [Web3py kaia extension GitHub 倉庫](https://github.com/kaiachain/kaia-sdk/tree/main/web3py-ext)。