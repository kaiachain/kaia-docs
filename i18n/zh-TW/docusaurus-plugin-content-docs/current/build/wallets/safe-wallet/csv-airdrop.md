...
請至 [app.safe.global](https://app.safe.global) 登入，並選擇您的 Kaia 或 Kairos Safe。如果您還沒有帳號，請按照 [建立保險箱](./use-safe-wallet.md#create-a-safe) 及 [新增資產](./use-safe-wallet.md#add-assets) 的步驟操作。
...
:::important
請使用 `,` 作為分隔符。標題列必須是第一行，且必須包含所述的欄位名稱。[範例傳輸檔案](https://ipfs.io/ipfs/bafybeiesr6b3cm76ofcm2joukgdtuyva3niftmbpbb4sgxsa3qwsenv3lu/sample.csv)
:::
