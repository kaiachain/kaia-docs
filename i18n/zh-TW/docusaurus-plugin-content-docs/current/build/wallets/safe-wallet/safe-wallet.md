...
您已經在使用 Kaia Safe 了嗎？ 請參閱 **[遷移至 Safe Global](./migrate-to-safe-global.md)** — 您的現有 Safe 帳戶不受影響，並可繼續在 Safe Wallet 上使用。
...
- [遷移至 Safe Global](./migrate-to-safe-global.md) — 從 `safe.kaia.io` 切換（現有帳戶維持不變）
- [在 Kaia 上使用 Safe Wallet](./use-safe-wallet.md) — 建立 Safe、新增資產並發送交易
- [概覽](./overview.md) — 網路與 Safe Global 資源
- [常見問題](./faqs.md) — 關於遷移與帳戶管理的問題
