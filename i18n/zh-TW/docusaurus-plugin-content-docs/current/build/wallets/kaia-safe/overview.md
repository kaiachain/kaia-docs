...
使用 [API Kit](./kaia-safe-api-kit.md) 或其他 Safe SDK 工具時，請傳入正確的 Kaia 鏈 ID。 隨著 `safe.kaia.io` 逐步停用，服務端點可能會有所變更；有關受支援的區塊鏈及設定，請參閱 Safe Global Transaction Service 的文件。
