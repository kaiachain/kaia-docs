...
「Kaia 數位代幣計畫」（以下簡稱「KAIA」，代碼為 KAIA）並非旨在構成受監管產品，例如證券、 法定貨幣代幣或電子貨幣、獲接納的虛擬資產或特定投資（上述各項均依阿布扎比全球市場《2015年金融服務與市場法規》（「FSMR」）所定義），亦不構成其等同產品或任何司法管轄區內的其他受監管產品。

由於 KAIA 並非阿布達比全球市場（“ADGM”）的受監管產品，因此該基金會目前無需向阿布達比全球市場金融服務監管局（“FSRA”）申請牌照。本基金會既未在阿布扎比全球市場（ADGM），亦未在任何司法管轄區內提供任何受監管的服務，亦未從事任何受監管的活動。
...
沒有任何監管機構批准本白皮書中的任何信息。任何司法管轄區的法律、監管要求或規則都沒有采取或不會採取任何此類行動。本白皮書的發佈、分發或傳播，並不意味著已遵守相關法律、監管要求或規則。
...
Finschia 區塊鏈基於全球通訊公司 LINE 於 2018 年發起的 LINE Blockchain，而 Klaytn 區塊鏈則於 2019 年在韓國領先軟體公司 Kakao 的基礎上建立， ——南韓領先的軟體公司——於2019年建立的 Klaytn 區塊鏈，兩者已基於「推動區塊鏈技術廣泛普及」的共同目標，將各自的區塊鏈及生態系統進行整合，並由此創立了 Kaia 區塊鏈。

Kaia 區塊鏈是基於 EVM（以太坊虛擬機）的第 1 層區塊鏈，其設計以可擴展性、便利性和可靠性為首要任務。 Kaia Blockchain 專注於轉型變革，在 Web 3.0 時代，這些變革不僅將增強技術和企業的能力，還將增強個人的能力。 Kaia DLT 基金會與生態系統參與者致力於讓區塊鏈技術更易於取得，並讓更多人參與 Web 3.0 革命。 Kaia 區塊鏈將作為一個可信的層，將世界各地不同背景的人聯繫在一起。

為了建立 Web 3.0 協作遊樂場的基礎設施，Kaia Blockchain 將結合強大的集成社區和基礎設施技術，以發現新機遇並加速創新。

### 使命

我們的目標是透過區塊鏈技術，為人們提供更廣闊的經濟機會及參與權，從而打造一個更公平、更開放的未來。

### 願景

Kaia Blockchain 的核心願景，在於整合龐大的用戶群、豐富的鏈上資產與技術，協助開發者迅速實現並拓展其構想，並取得成功成果。作為一個平台，Kaia Blockchain 為開發者提供所需的工具與環境，讓他們有機會將創新的解決方案介紹給更廣泛的公眾。他們計畫透過善用鏈上資產，並追求突破技術限制的創新，從而創造新的價值。開發者社群的持續成長與成功，是 Kaia 區塊鏈的核心目標之一。為了讓建設業者將抱負化為現實，我們將協助他們將願景化為現實，從構思階段到實施、進入市場，乃至業務成長，全程提供支援。

## 價值主張

Kaia Blockchain 旨在透過整合這兩條主網，打造亞洲首屈一指的區塊鏈，並引領 Web3 的普及，這正是這兩條區塊鏈的共同目標。透過以下所述的廣泛用戶群、豐富的鏈上資產以及技術領導力，協助開發者構思創意、持續成長並成功打造專案，即可實現此願景。 Kaia Blockchain 為各類規模的 Web3 專案提供穩健的基礎架構，為希望將創新構想化為現實的開發者創造了理想的環境。

### 廣泛的用戶群

1. **Web2 用戶的可及性**：Web3 專案面臨的最大問題之一，就是如何吸引 Web2 用戶。 Kaia Blockchain 透過與擁有 5,000 萬韓國用戶的 Kakao，以及在日本、台灣、印尼和泰國擁有 2 億用戶的 LINE 合作，利用整合即時通訊功能的錢包，讓現有的 Web2 用戶能輕鬆使用其服務。
2. **Web3 用戶可及性**：除了 Web2 用戶外，透過提供超過 120 萬個活躍錢包地址，以及一個串聯用戶與專案的介面，有助於快速且輕鬆地吸引 Web3 用戶加入該專案。
3. **社群建構支援**：透過與 Kaia DLT 基金會進行聯合行銷，協助使用者匯聚資源並推動專案，並為來自各條區塊鏈的使用者提供一個易於存取與使用的環境。

### 充裕的流動性支持

1. **實物資產（RWA）連結**：諸如黃金、船舶及房地產等實物資產，已存在於 Kaia 區塊鏈上。除此之外，各類由法幣擔保的穩定幣及債券等現實世界資產也將上鏈，讓開發者能夠運用更廣泛的資產。
2. **大型生態系統基金（Kaia 生態系統基金）：** 可以基於 KAIA 建立一個大型生態系統基金，並支援需要流動性的各個領域，例如 DeFi 和 GameFi。
3. **鏈上原生收益**：內建的 MEV（最大可提取價值）提取功能，讓 KAIA 質押者能夠在鏈上自動獲取 MEV 收益。這不僅能提升鏈上流動性，同時也提供了一種銷毀代幣的方法。

### 頂尖核心技術與開發便利性

1. **頂級交易最終性**：在維持 1 秒交易最終性的同時，提供更高的每秒交易處理量（TPS）與去中心化程度。
2. **以太坊相容性：** 基於 EVM 的去中心化應用程式（dApps）無需任何修改即可上線，並能實現 100% 的以太坊相容性。
3. **便捷的帳戶模型：** Kaia Blockchain 的帳戶模型允許為帳戶指派各種金鑰，這不僅能強化帳戶安全性，更能提升使用者體驗。
4. **無許可且去中心化的架構**：Kaia 區塊鏈正轉型為無許可的驗證者架構，同時也提升網路的去中心化程度。

## 代幣經濟

### 引言

公共區塊鏈平台是透過代幣模式來運作的，這對平台的發展方向具有重大影響。由於區塊鏈通常沒有中央管理機構，因此激勵那些維護和開發區塊鏈的個人，以確保其持續運作，至關重要。然而，若期望參與者僅出於利他動機參與區塊鏈安全工作，而不追求任何經濟利益，這是不切實際的。因此，有必要建立一套激勵機制，以激勵區塊鏈生態系統的參與者維護並發展該網路。

在區塊鏈中，治理結構是推動變革的動力。隨著現有技術不斷擴展及市場需求不斷變化，區塊鏈平台必須與時俱進，以跟上外部發展的步伐。與由單一公司或中央管理機構開發及維護的一般產品不同，公共區塊鏈並不適合由單一實體來制定並實施單方面決策。舉例來說，即使主要開發人員決定進行軟體更新，礦工們也未必會採用該更新。因此，需要建立一套治理流程，用以彙整生態系統中所有參與者的意見，並根據彙整的意見做出決策，以便區塊鏈網路能及時進行變更。區塊鏈必須具備穩定的治理架構，才能針對外部變化做出適當調整。

本章將說明 Kaia 區塊鏈的代幣模型與治理機制。 Kaia Blockchain 旨在憑藉其龐大的用戶群、豐富的鏈上資產及技術實力，協助開發者快速部署、擴展規模並取得成功成果。本文件將闡述用於打造 Kaia 區塊鏈現行功能的設計原則，以及這些功能未來可能的變動。本文件所提供的資訊將透過相關數據進行核實，其中部分內容在經過充分核實與審查後，可能會有所變更。

### 設計原則

設計區塊鏈平台的代幣經濟體系與治理架構是一項複雜的工作。首先，代幣經濟與治理結構是在受控條件下進行測試的，而這些條件並未能完全反映現實情況。因此，無法針對所有變數做好準備。此外，值得注意的是，區塊鏈產業仍處於萌芽階段，目前尚未出現任何能夠長期穩定運作的成功系統。 Kaia Blockchain 考量了這些環境因素，並制定了一套不受外部因素影響的內部原則，而非僅維持單一的特定模式。具體的代幣經濟機制與治理架構，可根據市場狀況及法規要求靈活調整。然而，這些設計原則將作為所有生態系統參與者共同的核心價值，維持不變。

Kaia Blockchain 代幣設計的核心原則如下：

- **獎勵生態系統貢獻者：** 若要讓區塊鏈平台能夠永續發展並為使用者帶來巨大價值，僅僅維持網路運作是不夠的；平台生態系統的成長同樣至關重要。因此，Kaia Blockchain 將識別推動此一成長的參與者，並根據每位參與者的貢獻程度，提供相應的獎勵與支援。此舉不僅能讓參與區塊生成與驗證的貢獻者，以及為平台生態系統發展做出貢獻的服務提供者，獲得與其貢獻成正比的合理報酬，同時也能對潛在的外部貢獻者產生強大的吸引力。
- **貢獻獎勵：** 此原則的具體實踐。透過基於貢獻的分配機制，包括驗證者及社群成員在內的網路參與者，若積極為既定的貢獻指標做出貢獻，將獲得與其貢獻程度相稱的獎勵；而未經貢獻獲得的獎勵則會被銷毀，從而減少實際淨發行量。
...
在 Kaia 區塊鏈主網上，每創建一個新區塊，就會發行一定數量的 KAIA。每當創建一個新區塊時，將會新發行一定數量的 KAIA，而 Kaia 區塊鏈的目標初始年通膨率（每年新發行的 KAIA 數量 / 市場上的 KAIA 代幣總量）將設定為 5.2%[^1]。此時，每個區塊新發行的 KAIA 數量不是永久性的，可以通過治理投票進行更改。默認情況下，KAIA 的通貨膨脹率反映了 Kaia 區塊鏈的經濟增長率。雖然目標值較低，但具體數值將通過治理來確定。從中長期來看，每個區塊的通脹率和新發行量可根據鏈中固有的通脹算法自動計算和應用。

值得注意的是，儘管總通膨率與每區塊發行量維持不變，但實際淨通膨率可能低於名義通膨率。這是因為未兌現的貢獻獎勵分配會依照治理機構核准的貢獻獎勵機制進行銷毀，從而減少新發行並進入流通的 KAIA 的實際總量。換言之，在現有的代幣銷毀機制之上，又因未經勞動獲得的貢獻獎勵而引入了額外的通縮壓力。此項減額的幅度取決於任何特定期間內，活躍驗證者的總貢獻水準。如需進一步詳情，請參閱「四層燃燒模型」下的「基於貢獻度的燃燒」一節。
...
每個區塊的區塊獎勵由創建區塊時發行的 KAIA 和交易費的總和決定。分配情況如下不過，整筆獎勵分配的具體比例和類別可根據治理情況進行調整。
...
_每當生成一個區塊時，指定用於貢獻獎勵的配額將累積至「Kaia 績效基金」（KPF）——這是專門用於貢獻獎勵的獎勵池——並可隨後根據治理機構核准的貢獻獎勵框架進行分配或銷毀。_

##### 銷燬

保持或提高 KAIA 價值的方法是任何基於 KAIA 的激勵結構的基本要素。在 Kaia 區塊鏈的生態系統成長階段，KAIA 的增發激發了生態系統成員的參與熱情。然而，要使其成為一種長期可持續的激勵措施，就必須有一種控制流通量的方法。 Kaia 區塊鏈的 4 層銷毀模型可防止通膨過度加劇。「四層銷毀模型」是一個廣泛的概念，不僅涵蓋 Kaia 區塊鏈固有的銷毀功能，還包含透過驗證者貢獻機制以及與生態系統專案的互動關係所產生的銷毀機制。這種大範圍銷燬模式將有效調節流通量，並在 Kaia 區塊鏈生態系統成熟時為網絡參與者提供穩定的價值激勵。各層的說明如下。
...
根據貢獻獎勵機制，驗證者獎勵分配中的一部分，僅會發放給符合既定鏈上貢獻門檻的驗證者。當驗證者未能完全達到這些門檻時，貢獻獎勵分配中尚未賺取的部分將不予發放，而是予以銷毀。這在網路參與度與代幣供應量之間建立了直接的關聯。銷毀金額是根據鏈上貢獻數據以確定性方式計算得出，並由基金會依據經治理機制批准的「貢獻獎勵」框架定期執行，無需針對每次銷毀進行單獨的治理投票。
...
為鼓勵治理委員會的驗證者為網路安全與發展做出貢獻，系統提供了兩類激勵措施：貢獻獎勵與質押獎勵。

- 貢獻獎勵旨在激勵驗證者，使其在區塊生成與驗證之外，積極為網路的成長做出貢獻。年度發行通膨總額的 10%（即 50% 驗證者與社群獎勵中的 20%）將分配至貢獻獎勵池，並根據各驗證者可量化的鏈上貢獻比例進行分配。若因驗證者未達到規定的貢獻門檻，導致配額中有任何部分尚未賺取，該部分將被銷毀，從而降低實際通膨率。這確保了代幣發行是與實際的網路成長掛鉤，而非無條件的分配。貢獻指標與運作參數由基金會依據經治理機構核准的「貢獻獎勵」框架進行定義與揭露，並可能予以調整。
- 質押獎勵用於質押 KAIA 併為 Kaia 區塊鏈的網絡穩定性和經濟穩定性做出貢獻。獎勵的大小根據特定驗證者的投注額與所有驗證者的 KAIA 總質押的比例確定。通貨膨脹總額的 40% 將作為定金獎勵。特定區塊的獎勵金額可能會有所不同，這取決於在特定時間內活躍的驗證者所投注的 KAIA 總數量。

#### Kaia 區塊鏈驗證器獎勵機制

每個街區都將有一個由隨機抽取的驗證員組成的委員會。每個委員會將有一名成員擔任提案人，所有其他委員會成員擔任核查人。

**貢獻獎勵分配：**
年度總發行量中 10% 的通膨獎勵（相當於 50% 驗證者與社群獎勵配額的 20%），將分配給貢獻獎勵，並根據驗證者在鏈上可量化的貢獻進行分配。每位驗證者所獲得的貢獻獎勵，是根據定期評估的貢獻指標來計算並分配的。

若驗證者未能對評估的貢獻指標做出足夠貢獻，該驗證者將無法獲得該期間的貢獻獎勵，且相應於未達貢獻門檻的部分 KAIA 代幣將被銷毀。關於貢獻獎勵分配的詳細規範，包括貢獻門檻、評估週期及符合資格的協議等，將予以公開披露，並可能不定期進行調整。

**交易手續費分配：**

關於交易手續費，若某個區塊中產生的交易手續費總額低於區塊提議者的獎勵，則該筆手續費將被銷毀。若交易手續費超過區塊提議者的獎勵，超額部分的一半將被銷毀，其餘一半則作為獎勵支付給區塊提議者。

這項規則本身並未改變。然而，隨著「貢獻獎勵」機制的推出，提案者的獎勵將歸零。因此，交易手續費中總有一半會被銷毀，另一半則始終支付給區塊提議者。

**質押獎勵分配：**
相當於年度總發行通膨量 40%（即 50% 驗證者與社群獎勵中的 80%）的質押獎勵，將根據各驗證者的質押金額比例，由驗證者們共同分享。只要 Kaia 區塊鏈驗證者滿足最低 500 萬 KAIA 注資要求，他們就可以自由注資或取消質押。提取已質押的 KAIA 需要延遲一週，以防止惡意會員立即提款。
...
3. Kaia DLT 基金會的運作：營運成本（各項服務成本，例如開發、會計、法律事務，以及 IT 基礎設施營運成本、行銷成本、人力成本等）、財務管理、募款等。
...
2019 年 6 月 24 日，在 Klaytn 區塊鏈主網啟動儀式上，創世區塊共發行了 100 億 KLAY。主網啟動後，根據創世發行量採用了 3% 的年通脹率，從區塊 1 開始，每個區塊新發行 9.6 KLAY。根據 2022 年 10 月的決議，自 2022 年 11 月 13 日起（#106444801），每區塊將發行 6.4 KLAY。至於 KLAY 的銷毀量，其中一部分是根據 2023 年 4 月 16 日的數據，從創世儲備中銷毀的；另一部分則是透過交易手續費銷毀及回購銷毀，從流通供應量中銷毀的。因此，截至 2024 年 6 月 27 日，整合時的總供應量估計為 59.71 億枚 KLAY。
...
加密貨幣的流通供應量是指特定現有加密貨幣發行總量的當前可交易供應總量。換句話說，就是在市場上實際交易和分配的數量。截至 2024 年 6 月 27 日（預計整合日期），Klaytn 區塊鏈的預估總供應量將為 5,971M KLAY，其中不包括尚未分配的 Klaytn 社群基金（KCF）[^2]（153M KLAY）、 Klaytn 基金會基金（KFF）[^3] 中的 2,900萬 KLAY，以及 KLAY 價值創造基金（KVCF）[^4] 中的 2,000,000,000 KLAY。這些數字是目前的估算，可能會因整塊生成狀況、通貨膨脹和治理提案的批准情況而略有不同。考慮到 KVCF 需要得到 GC 的單獨批准，在決定和執行 KCF 或 KFF 時，流通供應量會增加。另一方面，當流通供應量因交易費用或回購而被燒燬時，流通供應量就會減少。因此，截至 2024 年 6 月 27 日，估計已發行總量為 5,971M KLAY，而流通量則為 3,789M KLAY。在合併之前，沒有使用 KVCF 的計劃。在鏈和代幣合併後，KLAY 的流通供應量將由 KAIA 的初始流通供應量繼承。

#### FNSA 發放/分配狀況

##### FNSA 發放量和銷燬量

根據議定書的發放機制，Finschia 的 FNSA 在每個區塊自動發放，每年的通貨膨脹率為當前總供應量的 15%。最初的供應總量為 6,734,458 FNSA。根據分配機制，發放的 FNSA 按 5:3:2 的相應比例分配給網絡貢獻獎勵、服務貢獻獎勵和儲備金。 FNSA 沒有被銷燬。截至 2024 年 6 月底（即預期整合日期），透過通貨膨脹發行的 FNSA 總數估計為 796.7 萬份 FNSA。
...
FNSA 的總供應量和流通供應量相等。換句話說，沒有單獨的非流通量。此外，為確保與 KLAY 的順利整合，FNSA 將在整合前將通貨膨脹率設為 0%，並在事先通知後停止新的發行。截至 2024 年 6 月 24 日（預計整合日期）為止，透過通膨機制發行的 FNSA 總數預估為 796.7 萬份。最終確認的 FNSA 供應總量將納入 KAIA 的初始分配，並按照商定的交換比例繼承。
...
- (+) 循環供應轉換（49.68 億 KAIA）
  - 轉換後的 KLAY 流通量：3,789M \* 1 = 3,789M KAIA
  - 轉換後的 FNSA 流通量：7.967M \* 148.079656 FNSA = 1,179M KAIA
- (-) 未流通量之轉換與銷毀
  - 估計未流通量換算：(Klaytn 價值創造基金 2,000M KLAY + Klaytn 社群基金 153M KLAY + Klaytn 基金會基金 29M KLAY) \* 1 = 2,182M KAIA
  - 從 2,182M KAIA 中銷毀 1,382M KAIA，剩餘 800M KAIA
- (+) 將銷毀後剩餘的未流通量轉換[^6]為流通供應量（8億 KAIA）
...
| 類別            | 金額                        |
| ------------- | ------------------------- |
| KLAY 流通供應量    | 3,789M KAIA               |
| FNSA 流通供應量    | 1,179M KAIA               |
| LINE NEXT 代表團 | 330M KAIA                 |
| Kaia 生態系統基金   | 2.7億 KAIA |
| 凱亞基礎設施基金      | 200M KAIA                 |
| 總供應量          | 5,768M KAIA               |

由於在 KAIA 轉換時所有未流通的數量都被銷燬，因此總供應量和流通供應量是一致的。據估計，整合後的流通供應量約為 57.68 億 KAIA。

然而，上述數字是根據截至 2024 年 5 月 14 日 GST 的發行量及流通量估算得出，最終數字可能會因 Klaytn 和 Finschia 的區塊生成狀態、通膨以及治理提案的批准情況而略有差異。

根據「3.5.」中提到的措施，代幣合併後的流通供應量可能會增加。 「Kaia 區塊鏈基金」或因銷毀而減少。但是，正如相關章節所規定的，任何額外的供應都必須事先公佈或經管理部門批准。
...
Kaia 治理體系主要基於三大組成部分運作：Kaia 社群、Kaia 理事會以及 Kaia DLT 基金會。 Kaia 社區包括所有 KAIA 持有者，他們有權通過管理論壇和社交渠道表達對 Kaia 主網運營的意見。 Kaia 理事會代表社區，根據其持有的代幣和社區授予的投票權，直接參與項目的管理決策。最後，Kaia DLT 基金會運用其在區塊鏈與 Web3 技術方面的專業知識，基於專業見解與數據提供佐證，以協助 Kaia 理事會進行決策，並透過治理機制落實所作出的決策。通過這種系統化的結構，Kaia Governance 確保了有效的決策和執行，並追求透明和公平的社區運作。
...
為了實現上述技術目標，Kaia 區塊鏈推出了各種技術功能。具體來說，共識和網絡拓撲結構有助於實現性能目標，而智能合約和鏈上治理則有助於實現透明度和可持續性。 ​​Kaia 區塊鏈的初期表現如下：
...
Kaia 區塊鏈通過其擴展的賬戶模型和智能合約功能，為服務開發提供了可擴展性。區塊鏈上的智能合約通過合約自動化提高了個人之間交易和合約的效率，智能合約的使用對區塊鏈和 dApp 生態系統產生了重大影響。合約條件可以編碼到智能合約中並自動執行，從而解決可信中介問題。智能合約通過降低完成交易所需的成本和時間，使區塊鏈生態系統能夠創建新的商業模式和經濟體系。 Kaia Blockchain 支援 KVM 執行環境，該環境專為實現高速與高效而設計，為去中心化應用程式（dApp）開發者及專案提供最佳且最迅速的開發環境。
...
●     _**難以預測的區塊提議者選取演算法：**_ 一種透過改變區塊提議者選取方式，使其難以預測，從而增強對 DoS 攻擊抵抗力的演算法。

●     _**VRank（驗證者聲譽評估框架）：**_ 一個用於評估驗證者聲譽的框架。

●     _**自主驗證者罰款系統：**_ 一種針對驗證者錯誤或惡意行為施加懲罰的系統。

●     _**系統交易與共識訊息：**_ 透過區塊提議者自動生成的「系統交易」，反映每個區塊中合約的最新共識資訊。
...
在適用法律、法規及規則允許的最大範圍內，Kaia DLT 基金會對於因您接受或依賴本白皮書或其任何部分而產生或與之相關的任何間接、特殊、附帶、衍生或其他任何類型的損失（不論是基於侵權、契約或其他原因） （包括但不限於收入、收益或利潤之損失，以及使用權或資料之損失），該等損失係因您接受或依賴本白皮書或其任何部分而產生或與之相關。

### 無陳述和保證

Kaia DLT 基金會並未且不聲稱作出任何形式的陳述、保證或承諾，亦特此聲明不對任何實體或個人作出任何陳述、保證或承諾，包括與本白皮書所載任何資訊的真實性、準確性及完整性有關的任何陳述、保證或承諾。

本白皮書所載之任何內容，均不應亦不得被視為針對 Kaia DLT 基金會未來表現或政策所作之承諾、聲明或保證。基金會和/或 Kaia Governance 可隨時根據本白皮書中介紹的最新路線圖，自行決定更改所有信息、功能、發行、分發和架構。

此外，Kaia DLT 基金會聲明，對於更新任何前瞻性陳述，或為反映未來發展、事件或情況而公開宣布對該等前瞻性陳述的任何修訂，概不承擔任何責任，即使日後有新資訊出現或發生其他事件亦然。

請注意，本白皮書也只是一份進行中的工作，其中的信息僅截至本白皮書封面上的日期。 Kaia DLT 基金會保留不時更新白皮書的權利。

### 定標服務

若您選擇參與 KAIA 質押計畫，Kaia DLT 基金會將以 Kaia 平台交易驗證者的身分，為您提供相關服務，並提供其私有節點，代您進行質押。任何適用的代表團獎勵將由 Kaia 協議決定，並將記入您的帳戶。

您確認並理解，Kaia DLT 基金會並不保證您將獲得任何授權獎勵，且此類質押服務並不構成定期存款產品或證券發行，亦不屬於《密克羅尼西亞聯邦證券法規》（FSMR）的監管範圍。

由於協議的解鎖期限或網路狀況，質押資產的提領可能會有所延遲，且 Kaia DLT 基金會無法保證「網路貢獻獎勵」的發放時程與金額。由於包括但不限於採用、投機、技術、安全和法規等因素，KAIA 主網和用於提供 KAIA 記賬服務的相關接口存在固有風險，KAIA 代幣和獎勵市場可能會劇烈波動。您同意並確認，Kaia DLT 基金會對上述任何變數或風險概不負責，亦不承擔任何法律責任。

### 不提供建議

本白皮書中的任何資訊均不應被視為針對 Kaia DLT 基金會或 KAIA 的商業、法律、財務或稅務建議。關於 Kaia DLT 基金會及其業務與營運，以及 KAIA，您應諮詢您自己的法律、財務、稅務或其他專業顧問。您應該知道，您可能需要無限期地承擔任何購買 KAIA 的財務風險。

### 對分發和傳播的限制

任何司法管轄區的法律、監管要求和規則都可能禁止或限制分發或傳播本白皮書或其中的任何部分。若適用任何限制，您應自行了解並遵守適用於您持有本白皮書或其部分內容（視情況而定）之任何限制，相關費用由您自行承擔，且 Kaia DLT 基金會對此不承擔任何責任。已獲得本白皮書，或已向其分發或傳播本白皮書副本，或以其他方式擁有本白皮書的人員不得出於任何目的向任何其他人分發、複製或以其他方式傳播本白皮書或其中包含的任何信息，也不得允許或導致發生上述行為。

### 風險和不確定性

有意購買 KAIA 的投資者，在進行任何 KAIA 購買交易之前，應仔細考量並評估與 Kaia DLT 基金會及其業務與營運相關的所有風險與不確定性，以及本白皮書及《條款與細則》中所載的所有資訊。
...
無論如何，Kaia DLT 基金會就 KAIA 的任何發行或分發，均不會產生任何費用。

\*\*不保證 KAIA 的功能或 KAIA 代幣經濟基礎設施的交付或實現。倘若上述任何風險及不確定性演變為實際事件，KAIA DLT 基金會的業務、 KAIA DLT 基金會的業務、財務狀況、營運成果及前景，均可能受到重大且不利的影響。在這種情況下，您可能會失去 KAIA 的全部或部分價值。如果您已經購買了 KAIA，則不能退款或換貨。

\*\*如果您對自己應採取的行動有任何疑問，應諮詢您的法律、財務、稅務或其他專業顧問。

---

[^1]: 具體數字經進一步審查和管理部門批准後可能會有變動。

[^2]: 為振興 Klaytn 生態系統和吸納開發人員而設立的基金，支出由管理部門批准後決定。

[^3]: 為運作現有的 Klaytn 基金會而設立的基金，其支出也是經管理部門批准後確定的。

[^4]: 為迎接 Klaytn 區塊鏈的飛速發展而建立的儲備金。

[^5]: 由於區塊獎勵等原因，Klaytn 和 Finschia 鏈的流通供應量可能會發生變化，直至鏈的合併。

[^6]: 未來的流通量只會因通貨膨脹和新的銷燬模式而發生變化。基金流通額的合併並不一定意味著清算，而且只能在管理批准的範圍內透明地執行。
