...
> **참고**: 메타마스크는 이더리움용 지갑으로 주로 사용되지만, 동일한 주소 구조로 인해 카이아 자기갑과도 호환됩니다. 카이아는 [카이아 월렛](../wallets/overview/kaia-wallet.md)이라는 브라우저 확장 지갑도 가지고 있어 기본적으로 메타마스크와 동일한 기능을 제공하지만 리믹스를 제외하면 다릅니다.

## 1단계 <a href="#install-metamask" id="install-metamask">메타마스크 설치하기</a>

* 이 예제에서는 크롬 브라우저를 사용할 것입니다.  ([**크롬 설치하기**](https://www.google.com/intl/en_us/chrome/)
