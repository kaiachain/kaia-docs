...
이 가이드를 통해 하드햇 검증 플러그인을 사용하여 CLI에서 바로 카이아스캔에서 스마트 컨트랙트의 소스 코드를 자동으로 검증할 수 있습니다.
...
인증에 성공했다면 [카이아스캔](https://kairos.kaiascan.io/address/0x3e360fC99c4383e3adaAE9742c0fC983fDAa0535?tabId=contract\&page=1)에 성공적으로 인증된 계약이 표시되고 계약 코드 링크가 있습니다.
...
* [카이아스캔의 하드햇 검증 플러그인 설정](https://docs.kaiascan.io/smart-contract-verification/hardhat-verify)
