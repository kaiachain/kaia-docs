...
- Remix용 카이아 플러그인](https\://ide.klaytn.foundation)을 방문하여 `MyERC721Card` 컨트랙트를 생성하세요. 전체 소스코드는 [ERC-721 스마트 컨트랙트 작성하기](#1-writing-erc-721-smart-contract)에서 확인하실 수 있습니다.
- 컨트랙트를 배포할 계정을 생성합니다.
