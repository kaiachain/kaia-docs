...
[app.safe.global](https://app.safe.global)에 로그인한 후, Kaia 또는 Kairos Safe를 선택하세요. 아직 계정이 없다면, [금고 만들기](./use-kaia-safe.md#create-a-safe)와 [자산 추가하기](./use-kaia-safe.md#add-assets)를 따라 진행해 주세요.
