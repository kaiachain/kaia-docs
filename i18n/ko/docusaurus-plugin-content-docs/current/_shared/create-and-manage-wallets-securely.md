...
Safe 계정에 충분한 잔액이 있는지 확인하십시오. Safe 계좌에 [입금](/build/wallets/kaia-safe/use-kaia-safe#add-assets)하는 방법에 대한 안내는 이 가이드를 참고하시기 바랍니다.
