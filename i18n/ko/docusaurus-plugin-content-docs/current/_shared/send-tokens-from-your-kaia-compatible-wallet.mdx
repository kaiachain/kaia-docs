...
<Tabs>
  ...
  <TabItem value="모바일" label="모바일">
    1. 지갑 홈페이지의 토큰 탭에서 KAIA 토큰을 선택하면 토큰 세부 정보가 표시되는 페이지에 액세스할 수 있습니다
       ![](/img/build/wallets/mm-m-select-kaia.jpg)
    2. 계속하려면 **보내기** 버튼을 탭하세요
    ...
    4. 이제 송금할 금액을 입력하고 **다음**
       ![](/img/build/wallets/mm-m-insert-amount.jpg)을 클릭할 수 있는 화면으로 이동합니다.
...
<Tabs>
  ...
  <TabItem value="모바일" label="모바일">
    ...
    2. KAIA 잔액
       ![](/img/build/wallets/kw-m-send-btn.jpg)과 같은 열에서 **보내기** 버튼을 바로 클릭합니다.
...
<Tabs>
  <TabItem value="브라우저" label="브라우저 확장" default>
    1. 홈페이지의 **토큰** 탭으로 이동하여 보내려는 토큰을 선택하면 토큰 세부 정보가 표시되는 페이지로 이동합니다.
       ![](/img/build/wallets/mm-erc20-homepage.png)
    2. 보내기\*\* 버튼을 클릭
       ![](/img/build/wallets/mm-erc20-send-btn.png)
    3. 수취인 주소와 송금할 토큰 금액을 입력하고 **계속**
       ![](/img/build/wallets/mm-erc20-input-ao.png)을 클릭합니다.
    4. 확인\*\* 버튼을 클릭하여 트랜잭션을 제출하고 ERC20 토큰을 전송하세요
       ![](/img/build/wallets/mm-erc20-tx-details.png)
  </TabItem>

  <TabItem value="모바일" label="모바일">
    1. 토큰\*\* 탭을 탭하고 보내려는 ERC20 토큰을 선택하면 토큰 세부 정보가 표시되는 페이지에 액세스합니다
...
<Tabs>
  <TabItem value="브라우저" label="브라우저 확장" default>
    1. 지갑 홈페이지의 **토큰 목록** 패널로 이동
       ![](/img/build/wallets/kw-erc20-token-list.png)
    2. 보내려는 토큰을 선택하면 토큰 세부 정보가 표시되는 페이지에 액세스합니다.
    3. 보내기\*\* 버튼을 클릭합니다.
       ![](/img/build/wallets/kw-erc20-send-btn.png)
    4. 수취인 주소와 송금할 토큰 수량을 입력하고 **진행**
       ![](/img/build/wallets/kw-erc20-input-ao.png)을 클릭합니다.
    5. 확인\*\* 버튼을 클릭하여 트랜잭션을 제출하고 ERC20 토큰을
       ![](/img/build/wallets/kw-erc20-tx-details.png)으로 전송합니다.
