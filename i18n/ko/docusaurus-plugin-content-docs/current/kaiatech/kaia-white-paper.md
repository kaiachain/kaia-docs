...
프로젝트 카이아 디지털 토큰(이하 “KAIA”, 티커 심볼 KAIA)은 아부다비 글로벌 마켓(Abu Dhabi Global Market)의 2015년 금융서비스 및 시장 규정(이하 “FSMR”)에 정의된 바와 같이, 또는 이에 상응하는 규정 하에 정의된 증권, 법정 화폐 토큰, 전자화폐, 인정된 가상자산 또는 아부다비 글로벌 마켓(이하 “FSMR”)의 2015년 금융서비스 및 시장 규정(Financial Services and Markets Regulations 2015)에 정의된 ‘지정 투자’ 등, 또는 이에 상응하는 규정이나 기타 관할권에서 규정된 상품을 구성할 의도가 없습니다.

KAIA는 아부다비 글로벌 마켓(“ADGM”) 내에서 규제 대상 상품에 해당하지 않으므로, 재단은 현재 아부다비 글로벌 마켓 금융서비스 규제 당국(“FSRA”)으로부터 인가를 받을 필요가 없습니다. 본 재단은 ADGM 또는 그 밖의 어떠한 관할권에서도 규제 대상 서비스를 제공하지 않으며, 규제 대상 활동을 수행하지 않습니다.
...
본 백서에 명시된 어떠한 정보도 규제 당국의 승인을 받은 바 없습니다. 어떠한 관할권의 법률, 규제 요건 또는 규칙에 따라 그러한 조치가 취해진 바 없으며 향후에도 취해지지 않을 것입니다. 본 백서의 발행, 배포 또는 전파가 해당 법률, 규제 요건 또는 규칙을 준수했음을 의미하지는 않습니다.
...
글로벌 메신저 기업 LINE이 2018년에 시작한 ‘LINE 블록체인’을 기반으로 한 핀스치아(Finschia) 블록체인과, 2019년 한국을 대표하는 소프트웨어 기업 카카오를 기반으로 설립된 클레이튼(Klaytn) 블록체인이, 한국을 대표하는 소프트웨어 기업인 카카오를 기반으로 2019년에 설립된 클레이튼(Klaytn) 블록체인은, 블록체인 기술의 대중화를 달성한다는 공동의 목표 아래 각자의 블록체인과 생태계를 통합하여 카이아(Kaia) 블록체인을 출범시켰습니다.

Kaia 블록체인은 EVM(이더리움 가상 머신) 기반의 레이어 1 블록체인이며, 확장성, 편의성, 안정성을 최우선으로 설계되었습니다. Kaia 블록체인은 웹 3.0 시대에 기술과 비즈니스뿐만 아니라 개인에게도 힘을 실어줄 혁신적인 변화에 집중합니다. 카이아 DLT 재단과 생태계 참여자들은 블록체인 기술에 대한 접근성을 높이고, 더 많은 사람들이 웹 3.0 혁명에 참여할 수 있도록 하는 것을 목표로 하고 있습니다. Kaia 블록체인은 전 세계 다양한 배경을 가진 사람들을 연결하는 신뢰받는 기반층으로 자리매김할 것이다.

협업형 웹 3.0 플랫폼의 기반을 구축하기 위해 Kaia 블록체인은 강력한 통합 커뮤니티 기술과 인프라 기술을 결합하여 새로운 기회를 발굴하고 혁신을 가속화할 것입니다.

### 사명

저희의 목표는 블록체인을 통해 사람들에게 더 많은 경제적 기회와 참여권을 보장함으로써, 보다 공정하고 개방적인 미래를 만들어가는 것입니다.

### 비전

카이아 블록체인의 핵심 비전은 광범위한 사용자 기반, 방대한 온체인 자산, 그리고 기술을 통합하여 개발자들이 자신의 아이디어를 신속하게 구현하고 확장하여 성공적인 성과를 거둘 수 있도록 돕는 것입니다. Kaia Blockchain은 플랫폼으로서 개발자들에게 필요한 도구와 환경을 제공함으로써, 그들이 창의적인 솔루션을 더 많은 대중에게 선보일 수 있는 기회를 마련해 줍니다. 이들은 온체인 자산을 활용하고 기술적 한계를 뛰어넘는 혁신을 추구함으로써 새로운 가치를 창출할 계획입니다. 빌더 커뮤니티의 지속적인 성장과 성공은 카이아 블록체인의 핵심 목표 중 하나입니다. 건축업자들이 포부를 현실로 만들 수 있도록, 저희는 아이디어 구상 단계부터 실행, 시장 진출, 성장에 이르기까지 건축업자들의 비전을 현실로 실현할 수 있도록 지원해 드릴 것입니다.

## 가치 제안

카이아 블록체인은 두 메인넷의 통합을 통해 아시아 최고의 블록체인을 구축하고, 두 블록체인의 공통 목표였던 웹3의 확산을 주도하는 것을 목표로 하고 있습니다. 이러한 비전은 아래와 같이 광범위한 사용자 기반, 풍부한 온체인 자산, 그리고 기술적 리더십을 통해 개발자들이 아이디어를 구상하고, 성장하며, 프로젝트를 성공적으로 구축할 수 있도록 지원함으로써 실현될 수 있습니다. 카이아 블록체인은 규모에 상관없이 모든 Web3 프로젝트를 위한 견고한 인프라를 제공하여, 혁신적인 아이디어를 현실로 구현하고자 하는 개발자들에게 이상적인 환경을 조성합니다.

### 광범위한 사용자층

1. **웹2 사용자 접근성**: 웹3 프로젝트가 직면한 가장 큰 문제 중 하나는 웹2 사용자를 유치하는 것입니다. 카이아 블록체인은 한국 내 5천만 명의 사용자를 보유한 카카오 및 일본, 대만, 인도네시아, 태국에서 2억 명의 사용자를 보유한 라인과의 협력을 통해, 메신저와 연동된 지갑을 제공함으로써 기존 웹2 사용자들이 손쉽게 접근할 수 있도록 합니다.
2. **Web3 사용자 접근성**: Web2 사용자뿐만 아니라, 120만 개 이상의 활성 지갑 주소와 사용자와 프로젝트를 연결하는 인터페이스를 제공함으로써 Web3 사용자를 빠르고 쉽게 프로젝트로 유치하는 데 도움이 됩니다.
3. **커뮤니티 구축 지원**: 카이아 DLT 재단과의 공동 마케팅을 통해 사용자들이 모여 프로젝트를 구축할 수 있도록 돕고, 다양한 체인의 사용자들이 쉽게 접근하고 이용할 수 있는 환경을 제공합니다.

### 풍부한 유동성 지원

1. **실물 자산(RWA) 연동**: 금, 선박, 부동산과 같은 실물 자산은 이미 카이아 블록체인에 존재합니다. 이뿐만 아니라, 다양한 법정화폐 담보형 스테이블코인 및 채권과 같은 실물 자산이 온체인화됨에 따라 개발자들은 더 폭넓은 범위의 자산을 활용할 수 있게 될 것입니다.
2. **대규모 생태계 펀드 (카이아 생태계 펀드):** KAIA를 기반으로 대규모 생태계 펀드를 조성하여 디파이(DeFi) 및 게임파이(GameFi)와 같이 유동성이 필요한 다양한 분야를 지원할 수 있습니다.
3. **체인 내 네이티브 수익**: 내장된 MEV(최대 추출 가능 가치) 추출 기능을 통해 KAIA 스테이커는 체인상에서 자동으로 MEV 수익을 얻을 수 있습니다. 이로 인해 체인의 유동성이 증가하는 동시에 토큰 소각을 위한 방안도 마련됩니다.

### 최고 수준의 핵심 기술과 개발 편의성

1. **최고 수준의 거래 확정성**: 1초 내 거래 확정성을 유지하면서 더 높은 TPS와 탈중앙화를 제공합니다.
2. **이더리움 호환성:** EVM 기반 dApp은 100% 이더리움 호환성을 보장하므로, 별도의 수정 없이 바로 도입할 수 있습니다.
3. **편리한 계정 모델:** 카이아 블록체인의 계정 모델은 계정에 다양한 키를 할당할 수 있도록 하여, 계정 보안을 강화하고 사용자 경험을 향상시킵니다.
4. **허가 없이 참여 가능한 탈중앙화 구조**: 카이아 블록체인은 허가 없이 참여 가능한 검증자 구조로 전환하는 동시에 네트워크의 탈중앙화 수준도 높이고 있습니다.

## 토큰 경제

### 서론

공개 블록체인 플랫폼은 토큰 모델을 통해 운영되며, 이는 플랫폼의 성장 방향에 큰 영향을 미칩니다. 블록체인은 일반적으로 중앙 관리 기관이 없기 때문에, 블록체인의 지속적인 운영을 보장하기 위해서는 이를 유지·개발하는 개인들에게 동기를 부여하는 것이 매우 중요합니다. 그러나 참가자들이 어떠한 금전적 이익도 추구하지 않고 오로지 이타적인 동기만으로 블록체인 보안 활동에 참여하리라고 기대하는 것은 비현실적이다. 따라서 블록체인 생태계 참여자들이 네트워크를 유지하고 발전시키도록 동기를 부여하기 위해서는 인센티브 제도가 필요합니다.

블록체인에서는 거버넌스 구조가 변화를 주도합니다. 이용 가능한 기술이 지속적으로 확대되고 시장의 요구가 변화함에 따라, 블록체인 플랫폼은 이러한 외부적 변화에 발맞춰 변화해야 합니다. 단일 기업이나 중앙 관리 기관이 개발하고 유지 관리하는 일반 제품과 달리, 퍼블릭 블록체인은 단일 주체가 일방적인 결정을 내리고 실행하기에 적합하지 않습니다. 예를 들어, 주요 개발자들이 소프트웨어 업데이트를 결정하더라도 채굴자들이 이를 적용하지 않을 수도 있습니다. 따라서 블록체인 네트워크가 적시에 변화를 구현할 수 있도록, 생태계의 모든 참여자들의 의견을 수렴하고 이를 바탕으로 의사결정을 내리는 거버넌스 프로세스가 필요합니다. 블록체인이 외부 변화에 적절히 대응할 수 있으려면 안정적인 거버넌스 구조가 마련되어 있어야 합니다.

이 장에서는 카이아 블록체인의 토큰 모델과 거버넌스 체계를 설명합니다. 카이아 블록체인은 방대한 사용자 기반, 막대한 온체인 자산 및 기술을 바탕으로 개발자들이 신속하게 구현하고, 확장하며, 성공적인 성과를 거둘 수 있도록 지원하는 것을 목표로 합니다. 이 문서에서는 카이아 블록체인의 현재 기능을 구현하는 데 적용된 설계 원칙과 이러한 기능이 향후 어떻게 변경될 수 있는지에 대해 살펴보겠습니다. 본 문서에 제공된 정보는 관련 데이터를 통해 검증될 예정이며, 충분한 검증 및 검토를 거친 후 본 내용의 일부가 변경될 수 있습니다.

### 디자인 원칙

블록체인 플랫폼의 토큰 경제와 거버넌스 구조를 설계하는 일은 복잡합니다. 첫째, 토큰 경제와 거버넌스 구조는 현실을 완전히 반영하지 않는 통제된 환경에서 테스트됩니다. 따라서 모든 변수에 대비할 수는 없습니다. 또한 블록체인 산업은 아직 초기 단계에 머물러 있으며, 장기적으로 안정적으로 운영되는 성공적인 시스템은 아직 등장하지 않았다는 점도 주목할 만합니다. 카이아 블록체인은 이러한 환경적 요인들을 고려하여, 특정 단일 모델을 고수하기보다는 외부 요인의 영향을 받지 않는 내부 원칙을 정립했습니다. 상세한 토큰 경제 체계와 거버넌스 구조는 시장 상황과 규제 환경에 따라 유연하게 변화할 수 있습니다. 그러나 이러한 설계 원칙은 모든 생태계 참여자들이 공유하는 핵심 가치로서 변함없이 유지될 것입니다.

카이아 블록체인의 토큰 설계에 적용된 핵심 설계 원칙은 다음과 같습니다:

- **생태계 기여자에 대한 보상:** 블록체인 플랫폼이 지속 가능성을 확보하고 사용자에게 큰 가치를 제공하려면, 단순히 네트워크를 유지하는 것만으로는 부족하며, 플랫폼 생태계의 성장 또한 매우 중요합니다. 따라서 카이아 블록체인은 이러한 성장에 기여하는 주체들을 파악하고, 각 참여자의 기여도에 상응하는 보상과 지원을 제공할 것입니다. 이를 통해 블록 생성 및 검증에 기여한 참여자뿐만 아니라 플랫폼 생태계의 성장에 기여한 서비스 제공자들도 기여도에 비례하여 합리적인 보상을 받게 되며, 이는 잠재적인 외부 참여자들에게 매력적인 인센티브가 될 것입니다.
- **기여 보상:** 이 원칙을 구체적으로 구현한 사례입니다. 기여도 기반 분배 메커니즘을 통해, 정의된 기여도 지표에 적극적으로 기여하는 검증자 및 커뮤니티 구성원을 포함한 네트워크 참여자들은 기여도에 상응하는 보상을 받게 되며, 미수령 보상은 소각되어 실질적인 순발행량이 감소합니다.
...
Kaia 블록체인 메인넷에서는 새로운 블록이 생성될 때마다 일정량의 KAIA가 발행됩니다. 새로운 블록이 생성될 때마다 일정량의 KAIA가 새로 발행되며, 카이아 블록체인의 목표 초기 연간 인플레이션율(연간 신규 발행되는 KAIA의 양 / 시중에 유통되는 총 KAIA 토큰 수)은 5.2%로 설정됩니다[^1]. 이 시점에서 블록당 신규 발행되는 KAIA의 수는 영구적으로 고정된 것이 아니며, 거버넌스 투표를 통해 변경될 수 있습니다. 기본적으로 KAIA의 인플레이션율은 Kaia 블록체인 경제 성장률을 반영합니다. 목표치는 낮은 값이지만 정확한 값은 거버넌스를 통해 결정될 것입니다. 중장기적으로는 인플레이션 알고리즘이 체인에 내재되어 있어 인플레이션율과 블록당 신규 발행량을 자동으로 계산하여 적용할 수 있습니다.

총 인플레이션율과 블록당 발행량은 변함이 없지만, 실질 순인플레이션율은 명목 인플레이션율보다 낮을 수 있다는 점에 유의해야 합니다. 이는 거버넌스에서 승인된 기여 보상 메커니즘에 따라 미수령 기여 보상이 소각됨으로써, 유통에 진입하는 신규 발행 KAIA의 실제 물량이 감소하기 때문입니다. 즉, 기존의 소각 구조에 더해, 무상 기여 보상을 통한 추가적인 디플레이션 압력이 발생하게 됩니다. 이러한 감소폭은 특정 기간 동안 활동 중인 유효성 검증자들의 총 기여도에 따라 달라집니다. 자세한 내용은 ‘4단계 소각 모델’의 ‘기여도 기반 소각’ 섹션을 참조하십시오.
...
_기여 보상으로 지정된 할당량은 각 블록 생성 시마다 기여 보상을 위한 전용 보상 풀인 카이아 성과 펀드(KPF)에 적립되며, 이후 거버넌스에서 승인된 기여 보상 체계에 따라 분배되거나 소각될 수 있습니다._

##### 소각

KAIA 가치 유지 또는 증대 방법은 KAIA 기반 인센티브 구조의 핵심 요소입니다. Kaia 블록체인 생태계 성장 단계에서는 KAIA의 추가 발행이 생태계 구성원의 참여를 유도합니다. 그러나 장기적으로 지속 가능한 인센티브로 기능하기 위해서는 유통량 조절 방법이 필요합니다. 카이아 블록체인의 4단계 소각 모델은 과도한 인플레이션을 방지합니다. ‘4단계 소각 모델’은 카이아 블록체인의 고유한 소각 기능뿐만 아니라, 검증자 기여 메커니즘 및 생태계 프로젝트와의 관계를 통해 발생할 수 있는 소각 개념까지 포괄하는 광범위한 개념입니다. 이 포괄적인 소각 모델은 Kaia 블록체인 생태계가 성숙기에 도달했을 때 유통량을 효과적으로 조절하고 네트워크 참여자들에게 안정적인 가치 인센티브를 제공할 것입니다. 각 단계에 대한 설명은 다음과 같습니다.
...
기여도 보상 메커니즘에 따라, 검증자 보상 할당량 중 일부는 정해진 온체인 기여도 기준을 충족하는 검증자에게만 분배됩니다. 검증자가 이러한 기준을 완전히 충족하지 못할 경우, 기여 보상 배분액 중 미지급된 부분은 분배되지 않고 소각됩니다. 이를 통해 네트워크 참여와 토큰 공급 사이에 직접적인 연관성이 형성됩니다. 소각량은 온체인 기여도 데이터를 바탕으로 결정론적으로 산정되며, 거버넌스에서 승인된 ‘기여 보상’ 체계에 따라 재단에서 주기적으로 실행되므로, 각 소각 건마다 별도의 거버넌스 투표를 거칠 필요가 없습니다.
...
거버넌스 위원회 검증자들이 네트워크의 보안과 성장에 기여하도록 장려하기 위해 두 가지 유형의 인센티브가 제공됩니다. 바로 기여 보상과 스테이킹 보상입니다.

- 기여 보상은 검증자들이 블록 생성 및 검증 외에도 네트워크 성장에 적극적으로 기여하도록 장려합니다. 발행된 연간 총 인플레이션의 10%(50%에 해당하는 검증자 및 커뮤니티 보상의 20%)는 기여 보상 풀에 배정되며, 각 검증자의 측정 가능한 온체인 기여도에 비례하여 분배됩니다. 검증자가 정해진 기여도 기준을 충족하지 못해 배분된 금액 중 미사용 상태로 남는 부분은 소각되며, 이를 통해 실질 인플레이션율이 낮아집니다. 이를 통해 토큰 발행이 무조건적인 분배가 아닌, 실제로 달성된 네트워크 성장에 연동되도록 보장합니다. 기여도 지표 및 운영 매개변수는 거버넌스 승인을 받은 ‘기여도 보상’ 체계에 따라 재단에서 정의 및 공개하며, 향후 조정될 수 있습니다.
- 스테이킹 보상은 KAIA를 스테이킹하고 Kaia 블록체인의 네트워크 안정성 및 경제적 안정성에 기여한 것에 대한 보상입니다. 보상 규모는 특정 검증자가 스테이킹한 금액이 전체 검증자가 스테이킹한 KAIA 총량에 차지하는 비율에 따라 결정됩니다. 총 인플레이션의 40%가 스테이킹 보상으로 할당됩니다. 특정 블록의 보상 규모는 특정 시점에 활동 중인 검증자들이 스테이킹한 총 KAIA 수에 따라 달라질 수 있습니다.

#### Kaia 블록체인 검증자 보상 메커니즘

모든 블록은 무작위로 선정된 검증자로 구성된 위원회를 갖습니다. 각 위원회에는 제안자 역할을 하는 구성원 1명이 있으며, 나머지 위원회 구성원들은 검증자 역할을 수행합니다.

**기여도 보상 분배:**
연간 발행 인플레이션 총량의 10%(검증자 및 커뮤니티 보상 할당량 50%의 20%에 해당)가 기여도 보상으로 배정되며, 이는 검증자들의 측정 가능한 온체인 기여도를 기준으로 분배됩니다. 각 검증자가 획득한 기여 보상은 정기적으로 평가되는 기여 지표에 따라 산정 및 분배됩니다.

검증자가 평가 대상 기여 지표에 충분히 기여하지 못할 경우, 해당 검증자는 해당 기간 동안 기여 보상을 받지 못하며, 미달된 기여 기준치에 해당하는 KAIA 토큰은 소각됩니다. 기여도 보상 분배를 규율하는 세부 매개변수(기여도 기준치, 평가 주기, 대상 프로토콜 등)는 공개될 예정이며, 주기적으로 조정될 수 있습니다.

**거래 수수료 배분:**

거래 수수료와 관련하여, 한 블록에서 발생한 총 거래 수수료가 블록 제안자 보상보다 적을 경우, 해당 수수료는 소각됩니다. 거래 수수료가 블록 제안자 보상을 초과할 경우, 초과 금액의 절반은 소각되고 나머지 절반은 블록 제안자에게 보상으로 지급됩니다.

규칙 자체는 변하지 않았습니다. 그러나 기여 보상 제도가 도입됨에 따라 제안자 보상은 0이 됩니다. 그 결과, 거래 수수료의 절반은 항상 소각되며, 나머지 절반은 항상 블록 제안자에게 지급됩니다.

**스테이킹 보상 분배:**
연간 발행 인플레이션 총액의 40%(검증자 및 커뮤니티 보상 50% 중 80%)에 해당하는 스테이킹 보상은 검증자들의 스테이킹 금액 비율에 따라 배분됩니다. Kaia 블록체인 검증자는 최소 5백만 KAIA 스테이킹 요건을 충족하는 한 자유롭게 KAIA를 스테이킹하거나 언스테이킹할 수 있습니다. 악의적인 참여자의 즉각적인 인출을 방지하기 위해 스테이킹된 KAIA를 인출하려면 1주일의 지연 기간이 필요합니다.
...
3. 카이아 DLT 재단의 운영: 운영 비용(개발, 회계, 법무 등 다양한 서비스 비용은 물론 IT 인프라 운영 비용, 마케팅 비용, 인건비 등), 재무 관리, 자금 조달 등
...
2019년 6월 24일, Klaytn 블록체인의 메인넷 출시 시 제네시스 블록에서 총 100억 KLAY가 발행되었습니다. 메인넷 출시 후 제네시스 발행량을 기준으로 연간 3%의 인플레이션율이 적용되어 블록 1부터 각 블록마다 9.6 KLAY가 새로 발행되었습니다. 2022년 10월의 결정에 따라, 2022년 11월 13일(블록 #106444801)부터 각 블록마다 6.4 KLAY가 발행되었습니다. KLAY 소각량과 관련하여, 2023년 4월 16일 기준으로 제네시스 리저브의 일부가 소각되었으며, 거래 수수료 소각 및 자사주 매입 소각을 통해 유통 공급량의 일부가 소각되었습니다. 그 결과, 2024년 6월 27일 통합 시점 기준 추정 총 공급량은 5,971M KLAY입니다.
...
암호화폐의 유통 공급량은 특정 기존 암호화폐의 총 발행량 중 현재 거래 가능한 총 공급량을 의미합니다. 즉, 시장에서 실제로 거래되고 유통되는 양입니다. 통합 예정일인 2024년 6월 27일 기준으로, Klaytn 블록체인의 예상 총 공급량은 5,971M KLAY가 될 것이며, 여기에는 아직 분배되지 않은 Klaytn 커뮤니티 펀드(KCF)[^2] 153M KLAY와 아직 분배되지 않은 클레이튼 커뮤니티 펀드(KCF)[^3] 2,900만 KLAY, 클레이튼 재단 펀드(KFF)[^4] 2,900만 KLAY, 그리고 KLAY 가치 창출 펀드(KVCF)\[^5] 20억 KLAY를 제외한 수치입니다. 이 수치는 현재 추정치이며 블록 생성 상태, 인플레이션, 거버넌스 제안 승인 여부에 따라 다소 변동될 수 있습니다. KVCF는 GC의 별도 승인이 필요하므로, KCF 또는 KFF의 실행이 결정되고 실행될 때 유통 공급량이 증가합니다. 반면, 트랜잭션 수수료나 매입으로 인해 소각될 때는 유통 공급량이 감소합니다. 이에 따라 2024년 6월 27일 현재, 추정 총 발행량은 5,971M KLAY이며, 유통량은 3,789M KLAY입니다. 합병 시점까지 KVCF 사용 계획은 없습니다. KLAY 유통량은 체인 및 토큰 합병 후 KAIA의 초기 유통량으로 승계될 예정입니다.

#### FNSA 발행/분배 현황

##### FNSA 발행 및 소각량

Finschia의 FNSA는 프로토콜의 발행 메커니즘에 따라 현재 총 공급량 기준 연간 15%의 인플레이션율로 각 블록마다 자동 발행되었습니다. 초기 총 공급량은 6,734,458 FNSA였습니다. 발행된 FNSA는 분배 메커니즘에 따라 네트워크 기여 보상, 서비스 기여 보상, 예비금에 각각 5:3:2의 비율로 배분됩니다. FNSA 소각량은 없습니다. 통합 예정일인 2024년 6월 말 기준으로, 인플레이션을 통해 발행될 것으로 예상되는 FNSA의 총 발행량은 7.967M FNSA입니다.
...
FNSA의 총 공급량과 유통 공급량은 동일합니다. 즉, 별도의 미유통 물량이 존재하지 않습니다. 또한 FNSA는 KLAY와의 원활한 통합을 위해 통합 전 사전 공지 후 신규 발행 중단 및 인플레이션율을 0%로 설정할 예정입니다. 통합 예정일인 2024년 6월 24일 말 기준으로, 인플레이션을 통해 발행될 것으로 예상되는 FNSA의 총 수는 7.967M FNSA입니다. 최종 확정된 FNSA 총 공급량은 KAIA 초기 분배에 포함되며, 합의된 교환 비율에 따라 상속됩니다.
...
- (+) 유통 공급량 전환 (4,968M KAIA)
  - 환산된 KLAY 유통량: 3,789M \* 1 = 3,789M KAIA
  - 환산된 FNSA 유통량: 7.967M × 148.079656 FNSA = 1,179M KAIA
- (-) 미유통 물량의 전환 및 소각
  - 추정 미유통 물량 환산: (Klaytn 가치 창출 펀드 2,000M KLAY + Klaytn 커뮤니티 펀드 153M KLAY + Klaytn 재단 펀드 29M KLAY) × 1 = 2,182M KAIA
  - 2,182M KAIA 중 1,382M KAIA를 소각하여 800M KAIA를 남깁니다.
- (+) 소각 후 남은 미유통 물량을 유통 공급량으로 전환[^6] (8억 KAIA)
...
| 카테고리          | 금액          |
| ------------- | ----------- |
| KLAY 유통 공급량   | 3,789M KAIA |
| FNSA 유통 공급량   | 1,179M KAIA |
| LINE NEXT 대표단 | 330M KAIA   |
| 카이아 생태계 펀드    | 2억 7천만 KAIA |
| 카이아 인프라 펀드    | 200M KAIA   |
| 총 공급량         | 5,768M KAIA |

KAIA 전환 시 미유통량 전량이 소각되므로 총 공급량과 유통 공급량이 일치합니다. 통합 시점의 예상 유통 공급량은 약 5,768M KAIA입니다.

다만, 언급된 수치는 2024년 5월 14일 기준 GST의 발행량 및 유통량 추정치를 바탕으로 한 것이며, Klaytn 및 Finschia의 블록 생성 현황, 인플레이션, 거버넌스 제안 승인 여부에 따라 최종 수치는 다소 달라질 수 있습니다.

토큰 병합 이후의 유통 공급량은 “3.5.”항에 언급된 조치에 따라 증가할 수 있습니다. “카이아 블록체인 펀드” 또는 소각으로 인한 감소. 다만 관련 조항에 명시된 바와 같이 추가 공급은 사전 공지 또는 거버넌스 승인을 거쳐야 합니다.
...
카이아 거버넌스는 카이아 커뮤니티, 카이아 위원회, 카이아 DLT 재단이라는 세 가지 주요 구성 요소를 기반으로 운영됩니다. Kaia 커뮤니티는 모든 KAIA 보유자를 포괄하며, 이들은 거버넌스 포럼과 소셜 채널을 통해 Kaia 메인넷 운영에 대한 의견을 표명할 권리를 가집니다. Kaia 협의회는 커뮤니티를 대표하며 보유한 코인과 커뮤니티로부터 위임받은 의결권을 바탕으로 프로젝트의 거버넌스 결정에 직접 참여합니다. 마지막으로, 카이아 DLT 재단은 블록체인 및 웹3 기술에 대한 전문성을 활용하여, 카이아 위원회가 의사 결정을 내리고 거버넌스를 통해 결정된 사항을 이행하는 데 도움이 될 수 있는 전문 지식과 데이터를 바탕으로 한 근거를 제공합니다. Kaia 거버넌스는 이러한 체계적인 구조를 통해 효과적인 의사 결정과 실행을 보장하며 투명하고 공정한 커뮤니티 운영을 추구합니다.
...
Kaia 블록체인 펀드 구체적으로, 성능 목표는 합의 알고리즘과 네트워크 토폴로지를 통해 달성되며, 투명성과 지속 가능성은 스마트 컨트랙트와 온체인 거버넌스를 통해 실현됩니다. ​​카이아 블록체인의 초기 성능은 다음과 같습니다:
...
●     _**예측 불가능한 제안자 선정 알고리즘:**_ 블록 제안자 선정 방식을 예측하기 어렵게 변경함으로써 DoS 공격에 대한 저항력을 강화하는 알고리즘입니다.

●     _**VRank (검증자 평판 평가 프레임워크):**_ 검증자의 평판을 평가하는 프레임워크입니다.

●     _**자율 검증자 슬래싱 시스템:**_ 검증자의 오류나 악의적인 행위에 대해 제재를 가하는 시스템.

●     _**시스템 트랜잭션 및 합의 메시지:**_ 블록 제안자가 자동으로 생성하는 “시스템 트랜잭션”을 통해 각 블록에 대한 최신 합의 정보를 계약서에 반영하는 것.
...
관련 법률, 규정 및 규칙이 허용하는 최대 한도 내에서, 카이아 DLT 재단은 귀하가 본 백서 또는 그 일부를 수락하거나 이에 의존함으로써 발생하거나 이와 관련하여 발생하는 간접적, 특별, 부수적, 결과적 또는 기타 모든 종류의 손실(불법행위, 계약 또는 기타 원인을 불문하고 (수익, 소득 또는 이익의 손실, 사용 또는 데이터의 손실을 포함하되 이에 국한되지 않음)에 대해 책임을 지지 않습니다.

### 진술 및 보증 부재

카이아 DLT 재단은 어떠한 단체나 개인에 대해서도, 본 백서에 명시된 정보의 진실성, 정확성 및 완전성과 관련된 진술, 보증 또는 약속을 포함하여, 어떠한 형태의 진술, 보증 또는 약속도 하지 않으며, 그러한 의도를 표명하지도 않으며, 이에 대해 일체 책임을 부인합니다.

본 백서에 포함된 어떠한 내용도 카이아 DLT 재단의 향후 실적이나 정책에 관한 약속, 진술 또는 보증으로 간주되거나 이에 의존되어서는 안 됩니다. 모든 정보, 기능, 발행, 배포 및 아키텍처는 본 백서에 제시된 당시의 로드맵에 따라 재단 및/또는 Kaia 거버넌스의 단독적이고 절대적인 재량에 따라 언제든지 변경될 수 있습니다.

또한, 카이아 DLT 재단은 향후 새로운 정보가 입수되거나 다른 사건이 발생하더라도, 향후 전개될 상황, 사건 또는 여건을 반영하기 위해 어떠한 미래 예측 진술을 갱신하거나 해당 진술에 대한 수정 사항을 공개적으로 발표할 책임을 일절 지지 않습니다.

본 백서는 진행 중인 작업물이며, 본 백서에 포함된 정보는 표지에 기재된 날짜 기준으로만 최신 정보임을 유의하시기 바랍니다. 카이아 DLT 재단은 수시로 백서를 업데이트할 권리를 보유합니다.

### 스테이킹 서비스

KAIA 스테이킹 프로그램에 참여하기로 선택하신 경우, 귀하에게 제공되는 해당 서비스는 Kaia DLT 재단이 Kaia 네트워크의 거래 검증자 역할을 수행하고, 귀하를 대신하여 스테이킹에 사용할 자체 프라이빗 노드를 제공함으로써 이루어질 수 있습니다. 적용 가능한 위임 보상은 Kaia 프로토콜에 따라 결정되며 귀하의 계정에 적립됩니다.

귀하는 카이아 DLT 재단이 귀하가 위임 보상을 반드시 받게 될 것이라고 보장하지 않으며, 이러한 스테이킹 서비스가 FSMR의 규제 대상에 해당하는 정기예금 상품이나 증권 발행에 해당하지 않는다는 점을 인정하고 이해합니다.

프로토콜의 스테이킹 해제 기간이나 네트워크 상황으로 인해 스테이킹된 자산의 인출이 지연될 수 있으며, 카이아 DLT 재단은 네트워크 기여 보상의 지급 시기와 금액을 보장할 수 없습니다. KAIA 스테이킹 서비스 제공에 사용되는 Kaia 메인넷 및 관련 인터페이스에는 내재된 위험이 있으며, KAIA 토큰 및 보상 시장은 채택, 투기, 기술, 보안 및 규제 등 여러 요인으로 인해 높은 변동성을 보일 수 있습니다. 귀하는 카이아 DLT 재단이 이러한 변수나 위험에 대해 어떠한 책임도 지지 않음을 동의하고 인정합니다.

### 조언 없음

본 백서에 포함된 어떠한 정보도 카이아 DLT 재단(Kaia DLT Foundation) 또는 KAIA에 관한 사업, 법률, 금융 또는 세무상의 조언으로 간주되어서는 안 됩니다. 카이아 DLT 재단(Kaia DLT Foundation) 및 해당 재단의 사업과 운영, 그리고 KAIA에 대해서는 본인의 법률, 재무, 세무 또는 기타 전문 고문과 상담하시기 바랍니다. KAIA 구매와 관련된 재정적 위험을 무기한으로 부담해야 할 수 있음을 인지해야 합니다.

### 배포 및 유포 제한

본 백서 또는 그 일부의 배포 또는 유포는 관할권의 법률, 규제 요건 및 규정에 의해 금지되거나 제한될 수 있습니다. 어떤 제한 사항이 적용되는 경우, 귀하는 Kaia DLT 재단에 대한 어떠한 책임도 지지 않는 조건으로, 본인의 비용으로 본 백서 또는 그 일부(상황에 따라)의 보유에 적용되는 모든 제한 사항을 스스로 확인하고 이를 준수해야 합니다. 본 백서에 접근 권한을 부여받거나, 본 백서의 사본을 배포 또는 유포받은 자, 또는 기타 방법으로 본 백서를 보유한 자는 어떠한 목적으로도 본 백서 또는 여기에 포함된 정보를 다른 사람에게 유포하거나 복제 또는 배포해서는 안 되며, 그러한 행위가 발생하도록 허용하거나 유발해서도 안 됩니다.

### 위험 및 불확실성

KAIA를 구매하려는 분들은 KAIA를 구매하기 전에 Kaia DLT 재단 및 그 사업과 운영과 관련된 모든 위험 및 불확실성, 그리고 본 백서 및 이용약관에 명시된 모든 정보를 신중하게 고려하고 평가해야 합니다.
...
카이아 DLT 재단은 어떠한 경우에도 KAIA의 발행 또는 유통과 관련하여 어떠한 비용도 부담하지 않을 것입니다.

**KAIA의 기능성 또는 KAIA 토큰 경제 인프라가 제공되거나 실현될 것이라는 보장은 없습니다. 만약 이러한 위험 및 불확실성 중 어느 하나라도 실제 사건으로 발전할 경우, 카이아 DLT 재단의 사업, 카이아 DLT 재단의 사업, 재무 상태, 경영 실적 및 전망에 중대하고 부정적인 영향을 미칠 수 있습니다. 이러한 경우, 귀하는 KAIA의 가치 전부 또는 일부를 잃을 수 있습니다. KAIA를 구매하신 경우, 구매 금액은 환불 또는 교환이 불가능합니다.**

**취해야 할 조치에 대해 의문이 있을 경우, 법률, 재무, 세무 또는 기타 전문 자문가에게 상담하시기 바랍니다.**

---

[^1]: 구체적인 수치는 추가 검토 및 거버넌스 승인을 거쳐 변경될 수 있습니다.

[^2]: 클레이튼 생태계 활성화 및 개발자 유치를 위해 조성된 기금으로, 지출은 거버넌스 승인 후 결정됩니다.

[^3]: 기존 클레이튼 재단 운영을 위해 조성된 기금으로, 지출 역시 거버넌스 승인 후 결정됩니다.

[^4]: Klaytn 블록체인의 급격한 성장을 대비하여 마련된 예비금입니다.

[^5]: 체인 병합 전까지 블록 보상 등으로 인해 클레이튼 및 핀시아 체인의 유통량은 변동될 수 있습니다.

[^6]: 향후 유통량은 인플레이션 및 새로운 소각 모델에 의해서만 변경됩니다. 기금의 유통량 편입은 반드시 청산을 의미하지 않으며, 거버넌스 승인 범위 내에서만 투명하게 실행됩니다.
