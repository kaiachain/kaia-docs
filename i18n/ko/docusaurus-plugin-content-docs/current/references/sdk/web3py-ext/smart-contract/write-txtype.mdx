...
```py contract_interaction_with_klaytn_type.py focus=1:2
...
```py contract_interaction_with_klaytn_type.py focus=3:7
...
```py contract_interaction_with_klaytn_type.py focus=9:11
...
```py contract_interaction_with_klaytn_type.py focus=12
...
```py contract_interaction_with_klaytn_type.py focus=15:18
...
```py contract_interaction_with_klaytn_type.py focus=16
...
```py contract_interaction_with_klaytn_type.py focus=17
...
<CH.Code>
```py contract_interaction_with_klaytn_type.py focus=20:21
...
```py contract_interaction_with_klaytn_type.py focus=23:27

```

---

You should pass **TxType.SMART_CONTRACT_EXECUTION** type to make a klaytn tx contract execution type

```py contract_interaction_with_klaytn_type.py focus=25
...
```py contract_interaction_with_klaytn_type.py focus=5,28
...
```py contract_interaction_with_klaytn_type.py focus=29
...
```py contract_interaction_with_klaytn_type.py focus=30
...
<CH.Code>
```py contract_interaction_with_klaytn_type.py focus=31
...
<CH.Code>
```py contract_interaction_with_klaytn_type.py focus=33:34
