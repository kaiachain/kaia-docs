...
<Editor module="/src/pages/viem-ext/기본 트랜잭션/레거시 트랜잭션.tsx" route={RoutePath.ViemExt_Legacy_Transaction} />

**TxTypeLegacyTransaction**은 이전에 Kaia에 존재했던 트랜잭션의 유형을 나타냅니다.
...
<CH.Spotlight>
  ...
  지갑 클라이언트의 **sendTransaction** 메서드를 사용해 레거시 트랜잭션에 서명하고 Kaia 블록체인으로 전송한 후 트랜잭션 해시를 기록합니다.
