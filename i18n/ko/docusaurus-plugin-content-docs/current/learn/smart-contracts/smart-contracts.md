...
- **개발자 친화적**: 이더리움에 익숙한 개발자는 익숙한 도구, 언어(예: 솔리디티), [개발 환경](../../build/smart-contracts/tools/ide-and-tools.md)을 사용하여 기존 스마트 컨트랙트를 카이아로 쉽게 마이그레이션하거나 새로운 스마트 컨트랙트를 구축할 수 있습니다.
