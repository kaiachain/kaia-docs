...
We are happy to announce that Kaia v1.8.4 has been released, with improvements for the ServiceChain, which is an integral part of Kaia’s Metaverse Package. This release has only to do with the ServiceChain, so there is no need to update your nodes that don’t support ServiceChain bridges.
