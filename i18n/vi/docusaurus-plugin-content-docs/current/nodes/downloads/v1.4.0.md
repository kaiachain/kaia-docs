...
## Release Notes for Kaia v1.4.0

### New features <a id="new-features"></a>

- Keystore V4
  - A new keystore standard [KIP-3](https://klaytn.github.io/kips/KIPs/kip-3) was adopted in Kaia to support its accounts.
...
- Optimized storage trie
  - Kaia now calculates storage root hashes for every block, not every transaction.
  - Kaia concurrently computes trie hash roots.
