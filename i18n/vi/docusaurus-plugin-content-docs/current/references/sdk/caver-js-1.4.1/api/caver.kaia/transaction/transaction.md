...
```javascript
caver.kaia.call(callObject [, defaultBlock] [, callback])
```
...
| ------------ | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| callObject   | Object             | A transaction object with the difference that for calls the from property is optional as well. [An encoded function call](../../caver.kaia.abi.md#encodefunctioncall) must be set in the data field of the transaction object. |
...
```javascript
caver.kaia.estimateGas(callObject [, callback])
```
...
```javascript
caver.kaia.estimateComputationCost(callObject [, defaultBlock] [, callback])
```
...
```javascript
> caver.kaia.estimateComputationCost({
...
```javascript
caver.kaia.decodeTransaction(rawTransaction)
```
...
**NOTE** caver.kaia.decodeTransaction is supported from **v1.0.1-rc.8**.  To use this feature, please install [v1.0.1-rc.8](https://www.npmjs.com/package/caver-js/v/1.0.1-rc.8) or higher.
...
```javascript
// Basic Transaction
> caver.kaia.decodeTransaction('0xf86b038505d21dba00843b9ac9ff94d03227635c90c7986f0e3a4e551cefbca8c5531685174876e8008026a06fc7412ad1801b4790e7a5a5097fdbef01bc9fe1b970d08232184d110226c221a04665f772edbc4ba4dfbf189d89a9b9cb1e5cdcea0fd5a8b1a497b9c275e5267c')
{ 
    type: 'LEGACY',
    nonce: '0x03',
...
// Fee Delegation
> caver.kaia.decodeTransaction('')
{ 
...
> caver.kaia.decodeTransaction('')
{ 
...
```javascript
caver.kaia.getTransaction(transactionHash [, callback])
```
...
| gasPrice           | QUANTITY     | Gas price provided by the sender in kei.                                                                                                                                                                                                                                                           |
...
| value              | QUANTITY     | Value transferred in kei.                                                                                                                                                                                                                                                                          |

**Example**

```javascript
> caver.kaia.getTransaction('0x2d26f602cfbb4c662931592bf2c4ee18d29f09683be5b9e8d589ff935fca0b97')
  .then(console.log);
{ 
...
```javascript
caver.kaia.getTransactionBySenderTxHash(senderTxHash [, callback])
```
...
```javascript
> caver.kaia.getTransactionBySenderTxHash('0x8c0b092fed92a6619666efd582f7d71fbc3d784781072dd26741715b3731ab22').then(console.log);
{
...
```javascript
caver.kaia.getTransactionFromBlock(hashStringOrNumber, indexNumber [, callback])
```
...
`Object` - A transaction object, see [caver.kaia.getTransaction](#gettransaction)

**Examples**

```javascript
> caver.kaia.getTransactionFromBlock('0x4534534534', 2).then(console.log);
// see caver.kaia.getTransaction
```

## getTransactionReceipt <a id="gettransactionreceipt"></a>

```javascript
caver.kaia.getTransactionReceipt(transactionHash [, callback])
```
...
```javascript
> caver.kaia.getTransactionReceipt('0x9108f22693de7b16ece4db2c8d11c004feae31973acc2ecb9dbd61cd57bb0d7b')
  .then(console.log);
{ 
...
```javascript
caver.kaia.getTransactionReceiptBySenderTxHash(senderTxHash [, callback])
```
...
```javascript
> caver.kaia.getTransactionReceiptBySenderTxHash('0x8c0b092fed92a6619666efd582f7d71fbc3d784781072dd26741715b3731ab22').then(console.log);
{
    blockHash: '0x56e950bd9283c11ad2dab7cfcbacd9164aff2f6cbeb99dd2a7b754eb210753af',
    blockNumber: 773,
    codeFormat: '0x0',
...
```javascript
caver.kaia.sendSignedTransaction(signedTransactionData [, callback])
```

Sends an already signed transaction, generated using `caver.kaia.accounts.signTransaction`.

**NOTE** `caver.kaia.sendSignedTransaction` can accepts an object as a parameter since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0). The object should include an RLP-encoded transaction string or should be an unencoded transaction object with signatures/feePayerSignatures. You can pass the returning object from caver.kaia.accounts.signTransaction, caver.kaia.accounts.feePayerSignTransaction, caver.kaia.accounts.getRawTransactionWithSignatures or caver.kaia.accounts.combineSignatures.
...
caver.kaia.sendSignedTransaction('0xf867808505d21dba0083015f9094247f2b7e9a9c51ebcc9449c7d9e7575f9baac36e0180824e43a02e50f5c4d279e17a80c3fe98327de7e48878e9d8141d26759ef64adcf66e6aa0a02ae9e8beac1ba8d5d215d87c33f9e05263b0bad163706c9dd7a563ee1e028f41').then(function(receipt){
    ...
})

// sendSignedTransaction using promise with returning object from caver.kaia.accounts.signTransaction
caver.kaia.sendSignedTransaction({
...
> caver.kaia.sendSignedTransaction('0xf867068505d21dba0083015f90940fd7697a8b9a46b0f770a3986e8a10b6ad6fffe10180824e44a0e591e4cbf4bdada2e559ce5b9c7b604c50d3b1d7d5a29939091bcc8ad4208aa3a01ef917ec539aa79b32a043b452e81840ea012796895cd5925273fd8df139595f')
...
```javascript
caver.kaia.signTransaction(transactionObject [, callback])
```
...
`Promise` returns `Object` - The RLP encoded transaction. The `raw` property can be used to send the transaction using [caver.kaia.sendSignedTransaction](#sendsignedtransaction).

**Example**

```javascript
> caver.kaia.signTransaction({
    nonce: 0,
