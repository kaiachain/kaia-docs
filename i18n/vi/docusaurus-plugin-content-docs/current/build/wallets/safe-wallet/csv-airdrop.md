...
Đăng nhập tại [app.safe.global](https://app.safe.global) và chọn két sắt Kaia hoặc Kairos của bạn. Nếu bạn chưa có tài khoản, hãy làm theo hướng dẫn [Tạo két sắt](./use-safe-wallet.md#create-a-safe) và [Thêm tài sản](./use-safe-wallet.md#add-assets).
