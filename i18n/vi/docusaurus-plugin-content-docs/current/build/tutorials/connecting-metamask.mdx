...
> **Note**: MetaMask is mostly used as a wallet for Ethereum, but it is also compatible with Kaia due to the identical address structures. Kaia cũng có một ví tiền điện tử dưới dạng tiện ích mở rộng trình duyệt có tên [Kaia Wallet](../wallets/overview/kaia-wallet.md), vì vậy nó cơ bản cung cấp các tính năng tương tự như MetaMask, ngoại trừ Remix.
