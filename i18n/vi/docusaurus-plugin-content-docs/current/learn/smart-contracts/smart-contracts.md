...
- **Thân thiện với nhà phát triển**: Các nhà phát triển quen thuộc với Ethereum có thể dễ dàng di chuyển các hợp đồng thông minh hiện có sang Kaia hoặc xây dựng các hợp đồng mới bằng các công cụ, ngôn ngữ quen thuộc (như Solidity) và [môi trường phát triển](../../build/smart-contracts/tools/ide-and-tools.md).
