...
Python](https://www.python.org/downloads/) 3.7.2+ をインストールする必要があります。

サンプルディレクトリの作成

```
> web3py-ext-examples を mkdir & cd _$ する。
```
