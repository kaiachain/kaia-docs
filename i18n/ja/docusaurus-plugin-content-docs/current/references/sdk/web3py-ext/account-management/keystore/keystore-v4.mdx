...
<CH.Spotlight>
  <CH.Code>
    ...
    v4_keystore_str = '''{
      ...
      "keyring"：[
        ...
        },
        {
          ...
          "kdfparams"：{
            "dklen"：32,
            "salt"："fca63eb0670a9bffcc67cb77f43525a8c93d49e0b24acbf7d2a98bff8a5cf1",
            "n"：4096,
            "r"：8,
            "p"：1
          },
    ...
    0x17226c9B4e130551c258Eb7B1Cdc927c13998cd60x3b0ac1c503373e1a8f4c35a71dbce404846d8a6173538680dea1d149fd5e494c
    0x17226c9B4e130551c258Eb7B1Cdc927c13998cd6 0x21558e1796ad364d34a0ad618f8b086c9af2694083a3cb129a0af10dc6b6cc9e
    New Keystores
    0x17226c9B4e130551c258Eb7B1Cdc927c13998cd6 0xeaffa1321040c44cfb8ae21cab8377198ef6706fb7b6b2a09db292b5fe2a5e63
    0x354688C7A16eA109Da83e386A86945Abe395cDfC0x3b0ac1c503373e1a8f4c35a71dbce404846d8a6173538680dea1d149fd5e494c
  ...
  ファイルからキーストアを読み込み、'**Kaia**'で**復号化**する。
  ...
  Account.encrypt\`を使用することで、同じアドレスと異なるパスワードで新しいキーストアを作成することができます。 現在、kaia-sdkはv3キーストアの作成のみをサポートしています。
  ...
  new_keystore`が`v4_keystore_str\` と同じ **public** と **private** キーを持っているか確認する。
