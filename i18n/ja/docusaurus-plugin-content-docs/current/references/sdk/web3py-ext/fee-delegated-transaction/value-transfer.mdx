...
TxType.FEE_DELEGATED_VALUE_TRANSFER**型の空のトランザクションを作成する。 empty_tx**ユーティリティを使えば、デフォルトのフィールドが埋められたtxを得ることができる。
...
``zsh output
❯ py txTypeFeeDelegatedValueTransferTransaction.py
署名された tx の生のトランザクション：
```
...
デコードされたトランザクション：{
  ...
  "signatures"：[
    {
      "v"：2037,
      "r"：506915148424983815670849504402583109757791219306486547462038310718807674553,
