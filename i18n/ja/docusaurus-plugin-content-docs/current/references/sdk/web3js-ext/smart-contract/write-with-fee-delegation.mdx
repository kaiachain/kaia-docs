...
296の前の番号

...
receipt {
  ...
  logs：[
    {
      アドレス：'0x95be48607498109030592c08adc9577c7c2dd505',
      topics：[Array],
      data：'0x0000000000000000000000000129',
      blockNumber: 148743711n,
...
web3.eth.account.privateKeyToAccount\`を使用して、定義された秘密鍵から**送信者**と**料金支払者**のアカウントを作成する。
...
contract.methods.increment().encodeABI()\`でコントラクト・メソッド・データをエンコードする。
