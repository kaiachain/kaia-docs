...
receipt {
  ...
  blockHash：'0xb9145a53ef85bc4b375de828d9c3387cadc6bcd8f81a8eaf4f0331a2d7a5c0',
...
送信者の**アドレス**、送信者の**秘密鍵**、および変更する新しい**役割ベースの秘密鍵**を定義する。
...
送信者のウォレットを、**更新者ロール**の秘密鍵とプロバイダーで作成する。
...
計算された**役割ベースの公開鍵**で**keys**フィールドにトランザクションを宣言する。
