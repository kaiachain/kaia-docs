...
送信者の**address**、送信者の**private key**、および変更する新しい**role-based private key**を定義する。
...
新しい**役割ベースの**秘密鍵から**public key**を計算する。
...
計算された**role-based public key**で**keys**フィールドにトランザクションを宣言する。
