...
Cancel トランザクションのトランザクションオブジェクトを定義する：パラメータ `type: TxType.Cancel` と `from: senderAddr` は必須である。
...
❯ node TxCancelType.js
receipt {
  blockHash: '0x8d3772ae12e4ef79b22631a10d02b2731e3b099327fd58367e3374639aed4ca',
  blockNumber: 148742706n,
  cumulativeGasUsed：21000n,
  effectiveGasPrice: 25000000000n,
  from: '0xa2a8854b1802d8cd5de631e690817c253d6a9153',
