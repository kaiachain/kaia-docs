...
### Kairos FaucetでKAIAを入手する<a href="#getting-klay-via-kairos-faucet" id="getting-klay-via-kairos-faucet"></a>

テスト用にKAIAが必要な場合は、[Kaia Faucet](../../../build/get-started/getting-kaia.md#kairos-testnet-and-faucet)からKairos testnet KAIAを入手できます。
...
カイアは、拡張性とパフォーマンスのために様々なトランザクションタイプを提供する。 詳細については、[Transactions](../../../build/transactions/) をご覧ください。 このセクションでは、caver-jsで使用できるいくつかの例について説明します。

### 手数料の委任<a href="#fee-delegation" id="fee-delegation"></a>

カイアは、[Fee Delegation](../../../build/transactions/transactions.md#fee-delegation) 機能を提供します。 以下は、あなたがこの種のトランザクションの送信者である場合に、RLPエンコードされたトランザクションを行う例である：
...
- [カウントDApp](https://docs.klaytn.foundation/docs/build/tutorials/count-dapp/)
