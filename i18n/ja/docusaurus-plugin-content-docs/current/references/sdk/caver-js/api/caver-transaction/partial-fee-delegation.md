...
```javascript
// FeeDelegatedValueTransferWithRatioを作成する
...
// RLPエンコードされた文字列からfeeDelegatedValueTransferWithRatioを作成する
...
```javascript
// FeeDelegatedValueTransferMemoWithRatioを作成する
...
// RLPエンコードされた文字列からfeeDelegatedValueTransferMemoWithRatioを作成する
...
```javascript
// FeeDelegatedAccountUpdateWithRatioを作成する
...
// RLPエンコードされた文字列からfeeDelegatedAccountUpdateWithRatioを作成する
...
```javascript
// FeeDelegatedSmartContractDeployWithRatioを作成する
...
// RLP エンコードされた文字列から feeDelegatedSmartContractDeployWithRatio を作成する
> caver.transaction.feeDelegatedSmartContractDeployWithRatio('
FeeDelegatedSmartContractDeployWithRatio {
...
```javascript
// FeeDelegatedSmartContractExecutionWithRatioを作成する
...
// RLP エンコードされた文字列から feeDelegatedSmartContractExecutionWithRatio を作成する
...
FeeDelegatedSmartContractExecutionWithRatio {
    ...
    _to：'0x7b65b75d204abed71587c9e519a89277766ee1d0',
    _value: '0xa',
    _input: '0x6353586b0000000000000000bc5951f055a85f41a3b62fd6f68ab7de76d299b2'
}.
```
...
```javascript
// FeeDelegatedChainDataAnchoringWithRatioを作成する
...
// RLPエンコードされた文字列からfeeDelegatedChainDataAnchoringWithRatioを作成する
