...
<CH.Spotlight>
  <CH.Code>
    ...
    */
    ...
    配置アドレス 0xb2F078a8Caed54322dDe974bf48fc11f04e6DdcD
    ```
  </CH.Code>
  ...
  */
  ...
  アビとバイトコードでコントラクト・インスタンスをデプロイするコントラクト・ファクトリーを作成する。
  ...
  <CH.Code>
    ...
    receipt {
      to: null,
      from: '0x24e8eFD18D65bCb6b3Ba15a4698c0b0d69d13f7',
  ...
  <CH.Code>
    ...
    ```zsh output
    ❯ node smartContractDeploy.js
    配置アドレス 0x9C28fD38a94145fEb0E24F2d188540D7FDDbE288
    ```
  </CH.Code>
</CH.Spotlight>
