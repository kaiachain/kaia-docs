...
<CH.Spotlight>
  <CH.Code>
    ...
    // Kaia V4で複数のロールベースの鍵 https://toolkit.klaytn.foundation/misc/generateKeystore
    const encryptedKey = `{
      "version"：4,
    ...
    // 復号化されたKeystore v4オブジェクトは、Keystore v4を再度暗号化するためにサポートされていないことを確認してください。 
    // したがって、この例ではKeystore v4を復号化し、keysotre v3として暗号化することのみを示す。
