...
<CH.Spotlight>
  <CH.Code>
    ...
    pubkey from unpressed format = 0x03dc9dccbd788c00fa98f7f4082f2f714e799bc0c29d63f04d48b54fe6250453cd
    ```
  </CH.Code>
  ...
  そうでなければ、**圧縮されていない16進数**から**公開鍵**を圧縮したい場合、**圧縮されていない公開鍵**を引数として、`getCompressedPublicKey`を使用する。
  ...
  <CH.Code>
    ...
    ```zsh output
    ❯ node addressUtils.js
    pubkey from uncompressed format = 0x03dc9dccbd788c00fa98f7f4082f2f714e799bc029d63f04d48b54fe6250453cd
    ```
  </CH.Code>
</CH.Spotlight>
