...
- kaiaは複数のトランザクション・タイプを提供し、各トランザクション・タイプが単一の目的を果たすようにするため、TxTypeValueTransferはKAIAを外部所有口座（EOA）に送信するように制限されている。
...
public class FeeDelegatedValueTransferExample implements keySample {
    ...
    public static void run() throws Exception {
        ...
        String to = "0x0000000000000000000000000000dead";
...
``zsh output
❯ java TxTypeFeeDelegatedValueTransfer.java
0x8bf9e4a253d5b22c04d38fbacd6c31b5605f21b782ad072c1ecd1c4aeee4a
```
...
class TransactionReceipt {
    ...
    ステータス：0x1
    txError: null
    to：0x0000000000000000000000000000dead
    transactionHash: 0x8bf9e4a253d5b22c04d38fbacd6c31b5605f21b782ad072c1ecd1c4aeee4a
