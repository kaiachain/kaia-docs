...
public class LegacyExample implements keySample {
        ...
        public static void run() throws Exception {
                ...
                String to = "0x000000000000000000000000dead";
                ...
                // web3j-credentialsでレガシートランザクションを送る
                ...
                // web3j-ext klaycredentialsでレガシートランザクションを送信
...
上記のパラメータを使用して生の**トランザクション**を作成する。
