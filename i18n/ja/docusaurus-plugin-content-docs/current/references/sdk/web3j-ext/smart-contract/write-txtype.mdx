...
public class WriteContractWithKlaytnTxTypeExample {
        ...
        public static void run() throws Exception {
                ...
                // 契約書込み（setNumber関数で数値を設定）
                Function function = new Function("setNumber", // 関数名
                                Arrays.asList(new Uint(BigInteger.valueOf(50))), // 関数入力パラメータ
                                Collections.emptyList()); // 関数戻りパラメータ
                ...
                // 契約後の数値を取得 Write
                System.out.println("契約後の数値 : " + counter.number().send());
