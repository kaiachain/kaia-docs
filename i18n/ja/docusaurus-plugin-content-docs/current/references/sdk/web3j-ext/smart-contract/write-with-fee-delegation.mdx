...
import org.web3j.abi.dattypes.Function;
import org.web3j.abi.dattypes.Uint;
import java.util.Arrays;
import java.util.Collections; public class Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write Write WriteCollections;
...
public class WriteContractWithFeeDelegationExample {
        ...
        public static void run() throws Exception {
                ...
                // 契約書き込み（setNumber関数で数値を設定）
                Function function = new Function("setNumber", // 関数名
                                Arrays.asList(new Uint(BigInteger.valueOf(50)), // 関数の入力パラメータ
                                Collections.emptyList()); // 関数の戻りパラメータ
                ...
                // 契約後の数を取得する Write
                System.out.println("契約後の数 : " + counter.number().send());
...
を書き込む前に、コントラクトに格納されている現在の\*\*番号を取得する。
...
を書いた後、コントラクトに格納されている更新された\*\*番号を取得する。
