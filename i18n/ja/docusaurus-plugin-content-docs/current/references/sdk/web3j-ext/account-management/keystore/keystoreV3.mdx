...
<CH.Spotlight>
  <CH.Code>
    ...
    public class DecryptKeystoreV3Example implements keySample {
        ...
        public static void run() throws Exception {
            ...
            for (String keyFile : keyFiles) {
                ...
                System.out.println("\tKaiaCredential : " + "Address：" + address + ", 秘密鍵：0x" + privateKey);
            }.
    ...
    ```zsh output
    ❯ java keystoreV3.java
    キーストアファイルからKaiaCredentialsをロードする：/Legacy_V3.json
    ...
    Keystore ファイルから KaiaCredentials をロードする：/Public_V3.json
    	KaiaCredential : アドレス：0xa2a8854b1802d8cd5de631e690817c253d6a9153, 秘密鍵：0xe4ca6d38096ad99324de0dde108587e5d7c600165ae4cd6c2462c597458c2b8
    ```
  </CH.Code>
  ...
  <CH.Code>
    ...
    ```zsh output
    KaiaCredentialsをkeystoreファイルから読み込みます：/Legacy_V3.json
    	KaiaCredential : アドレス：0xa2a8854b1802d8cd5de631e690817c253d6a9153, 秘密鍵：0xe4ca6d38096ad99324de0dde108587e5d7c600165ae4cd6c2462c597458c2b8
    Keystore ファイルから KaiaCredentials をロードする：/Public_V3.json
    	KaiaCredential : アドレス：0xa2a8854b1802d8cd5de631e690817c253d6a9153, 秘密鍵：0xe4ca6d38096ad99324de0dde108587e5d7c600165ae4cd6c2462c597458c2b8
    ```
