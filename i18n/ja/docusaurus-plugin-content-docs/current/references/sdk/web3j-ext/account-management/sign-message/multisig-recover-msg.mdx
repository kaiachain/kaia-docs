...
public class SignMsgWithMultiSigExample implements keySample {
        ...
        public static void run() throws Exception {
                ...
                KlayRecoverFromMessageResponse response3 = web3j
                                ...
                                .send();
                System.out.println("元のアドレス : " + from);
                System.out.println("キー1の結果アドレス : " + response1.getResult());
                System.out.println("キー2の結果アドレス ：" + response2.getResult());
...
3つのメッセージレスポンスから**アドレスを復元し、元の**from\*\*アドレスと比較する。
