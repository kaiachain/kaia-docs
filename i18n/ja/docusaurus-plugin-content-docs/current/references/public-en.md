...
これらのエンドポイントは、テストと開発の目的でコミュニティに提供されていることに留意してください。エンドポイントの稼働時間や安定性は保証できませんので、営利目的での使用はご遠慮ください。
...
| サービスプロバイダー                           | エンドポイント                                                      | 名前空間              | タイプ   |
| ------------------------------------ | ------------------------------------------------------------ | ----------------- | ----- |
| [カイア財団](https://www.kaia.io)         | `https://public-en-kairos.node.kaia.io`                      | kaia、klay、eth、net | 全文    |
...
アプリからAnkrに対してKaia RPC呼び出しを行っている場合は、サポート終了日までに\*\*[Ankrからの移行](./migrate-from-ankr.md)\*\*の手順に従ってください。ほとんどのプロジェクトでは、エンドポイントの変更は1行で済みます。
...
Alchemyは、Kaia向けのホスト型エンドポイントを備えたマネージドRPCインフラストラクチャに加え、開発者向けツール、ダッシュボード、利用状況分析機能を提供しています。

#### 特徴

- Kaia 向けのホスト型 HTTPS および WebSocket エンドポイント
- 利用状況ダッシュボードとリクエスト分析
- 無料プランに加え、より高いスループットに対応した有料プランもご用意しています
- Kaia で利用可能な API インターフェースについては、Alchemy のドキュメントを参照してください。

#### 参考文献

- [カイアが語る錬金術](https://www.alchemy.com/rpc/kaia)
- [ドキュメント](https://www.alchemy.com/docs)
- [ウェブサイト](https://www.alchemy.com/)
...
Kaiaのサポートは**2026年10月16日まで**ご利用いただけます。
...
- ウォレット[カイアウォレット](../build/wallets/overview/kaia-wallet.md)は、カイアネットワークのブラウザ拡張ウォレットです。
