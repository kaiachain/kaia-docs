...
Safeアカウントに十分な残高があることを確認してください。 Safeアカウントへの[入金](/build/wallets/kaia-safe/use-kaia-safe#add-assets)方法については、こちらのガイドをご参照ください。
