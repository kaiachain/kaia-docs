...
- 新しい設定とAPIを導入し、親/子チェーンに個別のガス制限設定を可能にした。 (#1353)
  ...
  - APIsubbridge_setParentBridgeOperatorGasLimit`、`subbridge_setChildBridgeOperatorGasLimit`、`subbridge_getParentBridgeOperatorGasLimit`、`subbridge_getChildBridgeOperatorGasLimit\`。
