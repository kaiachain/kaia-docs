---
sidebar_label: カイア 対 イーサリアム
---

# カイア vs イーサリアム：開発者向けの比較
...
| 特徴                     | イーサリアム                             | カイア                                                                                                                                                                                 |
| :--------------------- | :--------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **トランザクション毎秒処理数（TPS）** | \~ 15～30TPS（変動あり） | 最大4,000TPS リアルタイムのTPSはイーサリアムよりかなり高いと報告されている。                                                                                                                                        |
| **ブロックタイム**            | \~ 12秒            | 1秒のブロック生成時間。                                                                                                                                                                        |
...
| **トークン**               | ETH                                | [KAIA](https://docs.kaia.io/learn/token-economics/kaia-native-token/)                                                                                                               |
...
| **スマートな契約言語**   | Solidity, Vyper, Yul など。                                                                                                                           | Solidity, Vyper, Yul, Huff。                                                                                                                                                                                                                                                          |
