...
- 当初の年間インフレ率：5.2%.
- ブロック報酬は以下のように分配される：
  - CCOとコミュニティ：50％（20％が貢献報酬、80％がステーキング報酬）
...
- ブロックチェーン探索のための2つの主要ツール：
  - [Kaiascan](http://kaiascan.io/)：ブロック、トランザクション、アドレス、トークン、スマートコントラクトに関する洞察を提供する、カイアの公式ブロックエクスプローラ。
  - [OKX Kaia Explorer](https://web3.okx.com/explorer/kaia)：同様の機能を提供する代替ブロックエクスプローラ。
