...
手っ取り早く始めるために、このチュートリアルの完全なコードは[GitHub](https://github.com/kaiachain/kaia-dapp-mono/blob/main/examples/3rd-integration-examples/web3Auth.md)にあります。 レポジトリをクローンするか、ダウンロードすることでフォローすることができる。 レポジトリをクローンするか、ダウンロードすることでフォローすることができる。
