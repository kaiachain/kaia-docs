...
8. ソース・コード・フィールド\*\*で、**ソース・テキスト**を選択し、`Counter.sol`のソース・コードをテキスト・フィールドに貼り付ける。
...
9. サインして送信\*\*ボタンをクリックして確認し、検証を開始します。
...
検証パラメータを入力した後、**Sign and Submit** ボタンをクリックして確認し、検証を開始します。 認証が完了すると、**Submission Successful**というメッセージが表示されます。 これで、エクスプローラーの検索バーに契約書のアドレスを貼り付けて、**契約書のソースコード**、**契約書のABI**、**作成コード**を表示できる。
