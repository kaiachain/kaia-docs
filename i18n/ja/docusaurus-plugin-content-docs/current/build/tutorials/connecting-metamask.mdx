...
> **注**：MetaMaskは主にイーサリアム用のウォレットとして使用されていますが、アドレス構造が同一であるためカイアとも互換性があります。 Kaiaには[Kaia Wallet](../wallets/overview/kaia-wallet.md)というブラウザ拡張ウォレットもあり、Remixを除けば基本的にMetaMaskと同じ機能を提供している。
