...
[app.safe.global](https://app.safe.global) にログインし、お使いの Kaia または Kairos Safe を選択してください。まだアカウントをお持ちでない場合は、[セーフの作成](./use-safe-wallet.md#create-a-safe) および [資産の追加](./use-safe-wallet.md#add-assets) の手順に従ってください。
...
:::important
区切り文字として `,` を使用してください。ヘッダー行は最初の行でなければならず、記載された列名を含んでいる必要があります。[転送ファイルのサンプル](https://ipfs.io/ipfs/bafybeiesr6b3cm76ofcm2joukgdtuyva3niftmbpbb4sgxsa3qwsenv3lu/sample.csv)
:::
