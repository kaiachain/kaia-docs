...
`MyERC721Card.sol`はOpenZeppelinのERC721実装に基づいている。 `MyERC721Card.sol`はOpenZeppelinのERC721実装に基づいている。 A major part of the code in this tutorial is forked from OpenZeppelin 2.3
.
