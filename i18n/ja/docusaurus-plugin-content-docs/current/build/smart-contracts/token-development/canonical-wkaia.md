...
WKAIAをKAIAに戻すには、Kaiaエコシステムのスワップサービスを利用するか、ブロックエクスプローラーから直接コントラクトを呼び出してください。 `0xfd844c2fca5e595004b17615f891620d1cb9bbb2`にある、旧式の非正規なWKLAYラッパーに残高をお持ちの場合は、 [レガシー WKLAY を KAIA にアンラップする](../../tutorials/unwrap-legacy-wklay.md)を参照してください。