...
Kaia 项目数字代币（以下简称“KAIA”，股票代码为 KAIA）并非旨在构成受监管产品，例如证券、 法定代币或电子货币、获准的虚拟资产或特定投资——上述术语均依据阿布扎比全球市场《2015年金融服务与市场条例》（以下简称“FSMR”）的定义，或其等效法规，或任何司法管辖区内的其他受监管产品。

由于KAIA在阿布扎比全球市场（“ADGM”）中不属于受监管产品，因此该基金会目前无需获得阿布扎比全球市场金融服务监管局（“FSRA”）的许可。该基金会既不在阿布扎比全球市场（ADGM），也不在任何其他司法管辖区提供任何受监管的服务，亦不从事任何受监管的活动。
...
没有任何监管机构批准本白皮书中的任何信息。任何司法管辖区的法律、监管要求或规则都没有采取或不会采取任何此类行动。发布、分发或传播本白皮书并不意味着已遵守相关法律、监管要求或规则。
...
Finschia区块链基于全球即时通讯公司LINE于2018年发起的LINE区块链，而Klaytn区块链则于2019年在韩国领先软件公司Kakao的基础上建立， 韩国领先的软件公司Kakao，已将各自的区块链及生态系统进行整合，以实现区块链技术大规模普及这一共同目标，从而创建了Kaia区块链。

Kaia 区块链是基于 EVM（以太坊虚拟机）的第 1 层区块链，其设计以可扩展性、便利性和可靠性为首要任务。 Kaia Blockchain 专注于转型变革，在 Web 3.0 时代，这些变革不仅将增强技术和企业的能力，还将增强个人的能力。 Kaia DLT 基金会及生态系统参与者致力于让区块链技术更易于获取，并让更多人参与到 Web 3.0 革命中来。 Kaia 区块链将作为一个可信的层，将世界各地不同背景的人联系在一起。

为了建立 Web 3.0 协作游乐场的基础设施，Kaia Blockchain 将结合强大的集成社区和基础设施技术，以发现新机遇并加速创新。

### 使命

我们的目标是通过区块链技术，为人们提供更多的经济机会和参与权，从而构建一个更加公平、更加开放的未来。

### 愿景

Kaia区块链的核心愿景是整合庞大的用户群体、海量的链上资产以及先进技术，帮助开发者迅速实现并扩展他们的构想，并取得成功。作为一个平台，Kaia Blockchain 为开发者提供了所需的工具和环境，使他们有机会将富有创意的解决方案推广给更广泛的公众。他们计划通过利用链上资产，并致力于突破技术局限的创新，从而创造新的价值。开发者社区的持续成长与成功是Kaia区块链的核心目标之一。为了帮助建设者将理想变为现实，我们将协助他们将愿景变为现实，从构思阶段到实施、市场进入以及业务增长的各个环节。

## 价值主张

Kaia Blockchain 旨在通过整合这两条主网，打造亚洲第一的区块链，并引领 Web3 的普及——这正是这两条区块链的共同目标。通过以下方面的优势——广泛的用户群体、丰富的链上资产以及技术领导力——帮助建设者构思创意、实现成长并成功推进项目，这一愿景便能够得以实现。 Kaia Blockchain 为各种规模的 Web3 项目提供强大的基础设施，为希望将创新理念付诸实践的开发者创造了理想的环境。

### 广泛的用户群体

1. **Web2 用户的可访问性**：Web3 项目面临的最大问题之一是如何吸引 Web2 用户。 Kaia Blockchain 通过与拥有 5000 万韩国用户的 Kakao 以及在日本、台湾、印度尼西亚和泰国拥有 2 亿用户的 LINE 展开合作，借助集成于即时通讯应用的钱包，为现有 Web2 用户提供了便捷的访问途径。
2. **Web3 用户可访问性**：除了 Web2 用户外，该项目还通过提供超过 120 万个活跃钱包地址以及连接用户与项目的界面，能够快速、轻松地吸引 Web3 用户加入。
3. **社区建设支持**：通过与Kaia DLT基金会开展联合营销，帮助用户聚集并构建项目，并为来自不同区块链的用户提供一个易于访问和使用的环境。

### 充裕的流动性支持

1. **实物资产（RWA）关联**：黄金、船舶和房地产等实物资产已在Kaia区块链上存在。此外，各类由法币支持的稳定币和债券等现实世界资产也将上链，从而使开发者能够利用更广泛的资产。
2. **大规模生态系统基金（Kaia 生态系统基金）：** 可以基于 KAIA 创建一个大规模生态系统基金，为 DeFi 和 GameFi 等需要流动性的各个领域提供支持。
3. **链上原生收益**：内置的 MEV（最大可提取价值）提取功能，使 KAIA 质押者能够在链上自动赚取 MEV 收益。这不仅提高了链上流动性，同时也提供了一种销毁代币的方式。

### 顶尖的核心技术与便捷的开发体验

1. **顶级交易最终性**：在保持1秒交易最终性的同时，提供更高的TPS和更强的去中心化程度。
2. \*\*以太坊兼容性：\*\*基于 EVM 的去中心化应用（dApp）无需任何修改即可接入，并确保 100% 兼容以太坊。
3. **便捷的账户模型：** Kaia 区块链的账户模型支持为账户分配多种密钥，这不仅增强了账户安全性，还提升了用户体验。
4. **无许可且去中心化的架构**：Kaia区块链正在向无许可验证者架构转型，同时进一步提升网络的去中心化程度。

## 代币经济

### 引言

公共区块链平台通过代币模式进行维护，这极大地影响了平台的成长方向。由于区块链通常没有中央管理机构，因此激励那些维护和开发区块链的个人，以确保其持续存在，这一点至关重要。然而，指望参与者仅出于利他动机参与区块链安全工作，而不追求任何经济利益，是不切实际的。因此，有必要建立一套激励机制，以激励区块链生态系统的参与者维护和发展该网络。

在区块链中，治理结构推动着变革。随着现有技术的不断扩展和市场需求的变化，区块链平台必须进行变革，以跟上外部发展的步伐。与由单一公司或中央管理机构开发和维护的一般产品不同，公共区块链并不适合由单一实体做出并实施单方面决策。例如，即使主要开发者决定发布软件更新，矿工们也可能不会应用该更新。因此，需要建立一套治理流程，以收集生态系统中所有参与者的意见，并根据收集到的意见做出决策，从而使区块链网络能够及时实施变更。区块链必须具备稳定的治理结构，才能针对外部变化做出适当调整。

本章介绍了Kaia区块链的代币模型和治理体系。 Kaia Blockchain 旨在依托其庞大的用户群体、丰富的链上资产以及先进的技术，帮助开发者快速实施项目、实现规模化，并取得成功。本文将介绍用于构建 Kaia 区块链当前功能的设计原则，以及这些功能可能发生的变化。本文件中提供的信息将通过相关数据进行核实，部分内容在经过充分核实和审查后可能会有所变动。

### 设计原则

设计区块链平台的代币经济体系和治理结构是一项复杂的工作。首先，代币经济和治理结构是在受控条件下进行测试的，这些条件并不能完全反映现实情况。因此，无法对所有变量做好准备。此外还值得注意的是，区块链行业仍处于起步阶段，目前尚未出现一个能够长期稳定运行的成功系统。 Kaia Blockchain 考虑了这些环境因素，并制定了一套不受外部因素影响的内部原则，而非沿用单一的特定模型。具体的代币经济模型和治理结构可能会根据市场状况和监管要求灵活调整。不过，这些设计原则仍将作为所有生态系统参与者共同秉持的核心价值观而保持不变。

Kaia区块链代币设计的核心设计原则是：

- **对生态系统贡献者的奖励：** 对于一个区块链平台而言，要想实现可持续发展并为用户创造巨大价值，仅靠维护网络是不够的；平台生态系统的成长同样至关重要。因此，Kaia Blockchain 将识别为这一增长做出贡献的实体，并根据每位参与者的贡献程度提供相应的奖励和支持。这不仅将使参与区块生成和验证的贡献者，以及为平台生态系统发展做出贡献的服务提供商，都能获得与其贡献成比例的合理报酬，还将对潜在的外部贡献者起到极具吸引力的激励作用。
- \*\*贡献奖励：\*\*该原则的具体实践。通过基于贡献的分配机制，包括验证者及社区成员在内的网络参与者，只要积极为既定的贡献指标做出贡献，即可获得与其贡献程度相称的奖励；而未赚取的奖励将被销毁，从而减少实际净发行量。
...
在 Kaia 区块链主网上，每创建一个新区块，就会发行一定数量的 KAIA。每次生成一个新区块时，都会新发行一定数量的 KAIA，Kaia 区块链的目标初始年通胀率（每年新发行的 KAIA 数量 / 市场上的 KAIA 代币总量）将设定为 5.2%[^1]。此时，每个区块新发行的 KAIA 数量不是永久性的，可以通过治理投票进行更改。默认情况下，KAIA 的通货膨胀率反映了 Kaia 区块链的经济增长率。虽然目标值较低，但具体数值将通过治理来确定。从中长期来看，每个区块的通胀率和新发行量可根据链中固有的通胀算法自动计算和应用。

需要注意的是，尽管总通胀率和每区块发行量保持不变，但实际净通胀率可能低于名义通胀率。这是因为，根据治理机构批准的贡献奖励机制，尚未解锁的贡献奖励分配将被销毁，从而减少了新发行的KAIA实际进入流通的数量。换句话说，在现有的代币销毁机制基础上，通过无功劳的贡献奖励又引入了额外的通缩压力。该减少幅度的具体程度取决于任何给定时期内活跃验证者的总贡献水平。更多详情，请参阅“四层燃烧模型”下的“基于贡献的燃烧”部分。
...
每个区块的区块奖励由创建区块时发行的 KAIA 和交易费的总和决定。分配情况如下不过，整笔奖励分配的具体比例和类别可根据治理情况进行调整。
...
_每次区块生成时，指定用于贡献奖励的分配额度将累积至“Kaia绩效基金”（KPF）——这是一个专用于贡献奖励的奖励池，随后可根据治理机构批准的贡献奖励框架进行分配或销毁。_

##### 销毁

保持或提高 KAIA 价值的方法是任何基于 KAIA 的激励结构的基本要素。在 Kaia 区块链的生态系统成长阶段，KAIA 的增发激发了生态系统成员的参与热情。然而，要使其成为一种长期可持续的激励措施，就必须有一种控制流通量的方法。 Kaia区块链的4层销毁模型可防止通货膨胀过高。“四层销毁模型”是一个广泛的概念，不仅涵盖了Kaia区块链固有的销毁功能，还包括通过验证者贡献机制以及与生态系统项目的关系而可能产生的销毁机制。这种大范围销毁模式将有效调节流通量，并在 Kaia 区块链生态系统成熟时为网络参与者提供稳定的价值激励。各层的说明如下。
...
根据贡献奖励机制，验证者奖励分配中的一部分仅发放给达到规定链上贡献门槛的验证者。当验证者未能完全达到这些阈值时，贡献奖励分配中尚未赚取的部分将不予发放，而是被销毁。这在网络参与度与代币供应量之间建立了直接联系。销毁额度是根据链上贡献数据以确定性方式确定的，并由基金会根据经治理机制批准的“贡献奖励”框架定期执行，无需针对每次销毁单独进行治理投票。
...
为了鼓励治理委员会验证者为网络的安全与发展做出贡献，系统提供了两种激励机制：贡献奖励和质押奖励。

- 贡献奖励旨在激励验证者不仅参与区块生成和验证，还能积极为网络发展做出贡献。年度通胀总量中的10%（即50%验证者及社区奖励中的20%）将分配至贡献奖励池，并根据各验证者可量化的链上贡献比例进行分配。如果由于验证者未达到规定的贡献门槛，导致分配额度中有任何部分未被赚取，该部分将被销毁，从而降低实际通胀率。这确保了代币发行与网络的实际增长挂钩，而非无条件分配。贡献指标和运营参数由基金会根据治理机构批准的“贡献奖励”框架进行定义和披露，并可能进行调整。
- 质押奖励用于质押 KAIA 并为 Kaia 区块链的网络稳定性和经济稳定性做出贡献。奖励的大小根据特定验证者的投注额与所有验证者的 KAIA 总质押的比例确定。通货膨胀总额的 40% 将作为定金奖励。特定区块的奖励金额可能会有所不同，这取决于在特定时间内活跃的验证者所投注的 KAIA 总数量。

#### Kaia 区块链验证器奖励机制

每个街区都将有一个由随机抽取的验证员组成的委员会。每个委员会将有一名成员担任提案人，所有其他委员会成员担任核查人。

**贡献奖励分配：**
年度通胀发行总量中的10%（相当于50%验证者及社区奖励分配额的20%）将用于贡献奖励，并根据验证者在链上可量化的贡献进行分配。每位验证者获得的贡献奖励，是根据定期评估的贡献指标计算并分配的。

如果验证者未能对评估的贡献指标做出充分贡献，则该验证者将无法获得该周期的贡献奖励，且与未达成的贡献门槛相对应的 KAIA 代币将被销毁。关于贡献奖励分配的具体参数，包括贡献门槛、评估周期和符合条件的协议等，将予以公开披露，并可能定期进行调整。

**交易手续费分配：**

关于交易手续费，如果一个区块中产生的交易手续费总额低于区块提议者的奖励，则这些手续费将被销毁。如果交易手续费超过区块提议者的奖励，则超额部分的一半将被销毁，剩余的一半将作为奖励支付给区块提议者。

规则本身并没有改变。然而，随着“贡献奖励”机制的推出，提案人的奖励将变为零。因此，交易手续费中总有一半会被销毁，另一半则始终支付给区块提议者。

**质押奖励分配：**
相当于年度通胀总量40%（即50%的验证者奖励和社区奖励中的80%）的质押奖励，将根据验证者的质押金额比例在验证者之间进行分配。只要 Kaia 区块链验证者满足最低 500 万 KAIA 注资要求，他们就可以自由注资或取消质押。提取已质押的 KAIA 需要延迟一周，以防止恶意会员立即提款。
...
3. Kaia DLT 基金会的运营：运营成本（包括开发、会计、法律事务等各项服务费用，以及 IT 基础设施运营成本、市场营销成本、人力成本等）、财务管理、筹款等。
...
2019 年 6 月 24 日，在 Klaytn 区块链主网启动仪式上，创世区块共发行了 100 亿 KLAY。主网启动后，根据创世发行量采用了 3% 的年通胀率，从区块 1 开始，每个区块新发行 9.6 KLAY。根据2022年10月的决定，自2022年11月13日起（区块号#106444801），每个区块将发行6.4 KLAY。关于 KLAY 的销毁量，其中一部分是根据 2023 年 4 月 16 日的数据销毁的创世储备，另一部分则是通过交易手续费销毁和回购销毁从流通量中销毁的。因此，截至 2024 年 6 月 27 日，整合时的总供应量估计为 59.71 亿枚 KLAY。
...
加密货币的流通供应量是指特定现有加密货币发行总量的当前可交易供应总量。换句话说，就是在市场上实际交易和分配的数量。截至2024年6月27日（预计整合日期），Klaytn区块链的预计总供应量将为5,971M KLAY，其中不包括尚未分配的Klaytn社区基金（KCF）[^2]（153M KLAY）、 Klaytn基金会基金（KFF）[^3]的1.53亿KLAY，以及KLAY价值创造基金（KVCF）[^4]的20亿KLAY。这些数字是目前的估算，可能会因整块生成状况、通货膨胀和治理提案的批准情况而略有不同。考虑到 KVCF 需要得到 GC 的单独批准，在决定和执行 KCF 或 KFF 时，流通供应量会增加。另一方面，当流通供应量因交易费用或回购而被烧毁时，流通供应量就会减少。因此，截至2024年6月27日，KLAY的总发行量估计为5,971M KLAY，流通量为3,789M KLAY。在合并之前，没有使用 KVCF 的计划。在链和代币合并后，KLAY 的流通供应量将由 KAIA 的初始流通供应量继承。

#### FNSA 发放/分配状况

##### FNSA 发放量和销毁量

根据议定书的发放机制，Finschia 的 FNSA 在每个区块自动发放，每年的通货膨胀率为当前总供应量的 15%。最初的供应总量为 6,734,458 FNSA。根据分配机制，发放的 FNSA 按 5:3:2 的相应比例分配给网络贡献奖励、服务贡献奖励和储备金。 FNSA 没有被销毁。截至2024年6月底（即预计整合日期），通过通货膨胀机制发行的FNSA预计总数为796.7万份。
...
FNSA 的总供应量和流通供应量相等。换句话说，没有单独的非流通量。此外，为确保与 KLAY 的顺利整合，FNSA 将在整合前将通货膨胀率设为 0%，并在事先通知后停止新的发行。截至2024年6月24日（预计整合日期），通过通胀机制发行的FNSA预计总数为796.7万份。最终确认的 FNSA 供应总量将纳入 KAIA 的初始分配，并按照商定的交换比例继承。
...
- (+) 循环供应转换（49.68 亿 KAIA）
  - 转换后的KLAY流通量：3,789M \* 1 = 3,789M KAIA
  - 转换后的FNSA流通量：7.967M \* 148.079656 FNSA = 1,179M KAIA
- (-) 未流通量的转换和销毁
  - 预计未流通量换算：(Klaytn 价值创造基金 2,000M KLAY + Klaytn 社区基金 153M KLAY + Klaytn 基金会基金 29M KLAY) \* 1 = 2,182M KAIA
  - 从2,182M KAIA中销毁1,382M KAIA，剩余800M KAIA
- (+) 将销毁后剩余的未流通量转换[^6]为流通供应量（8亿KAIA）
...
| 分类            | 金额                        |
| ------------- | ------------------------- |
| KLAY 流通供应量    | 3,789M KAIA               |
| FNSA 流通供应量    | 1,179M KAIA               |
| LINE NEXT 代表团 | 330M KAIA                 |
| 凯亚生态系统基金      | 2.7亿 KAIA |
| 凯亚基础设施基金      | 200M KAIA简体中文（大陆）         |
| 总供应量          | 5,768M KAIA               |

由于在 KAIA 转换时所有未流通的数量都被销毁，因此总供应量和流通供应量是一致的。据估计，整合后的流通供应量约为 57.68 亿 KAIA。

不过，上述数据基于截至2024年5月14日GST的发行量和流通量估算，最终数据可能会因Klaytn和Finschia的区块生成状态、通胀以及治理提案的批准情况而略有差异。

在代币合并后，根据“3.5.”中提到的措施，流通供应量可能会增加。 “Kaia 区块链基金”或因代币销毁而减少。但是，正如相关章节所规定的，任何额外的供应都必须事先公布或经管理部门批准。
...
Kaia 治理体系基于三大核心组成部分运作：Kaia 社区、Kaia 理事会和 Kaia DLT 基金会。 Kaia 社区包括所有 KAIA 持有者，他们有权通过管理论坛和社交渠道表达对 Kaia 主网运营的意见。 Kaia 理事会代表社区，根据其持有的代币和社区授予的投票权，直接参与项目的管理决策。最后，Kaia DLT 基金会利用其在区块链和 Web3 技术方面的专业知识，基于专业知识和数据提供依据，以协助 Kaia 理事会做出决策，并通过治理机制落实这些决策。通过这种系统化的结构，Kaia Governance 确保了有效的决策和执行，并追求透明和公平的社区运作。
...
为了实现上述技术目标，Kaia 区块链推出了各种技术功能。具体来说，共识和网络拓扑结构有助于实现性能目标，而智能合约和链上治理则有助于实现透明度和可持续性。 ​​Kaia区块链的初期性能如下：
...
Kaia 区块链通过其扩展的账户模型和智能合约功能，为服务开发提供了可扩展性。区块链上的智能合约通过合约自动化提高了个人之间交易和合约的效率，智能合约的使用对区块链和 dApp 生态系统产生了重大影响。合约条件可以编码到智能合约中并自动执行，从而解决可信中介问题。智能合约通过降低完成交易所需的成本和时间，使区块链生态系统能够创建新的商业模式和经济体系。 Kaia 区块链支持 KVM 执行环境，该环境设计上兼具速度与效率，为 dApp 开发者和项目提供了最佳且最快捷的开发环境。
...
●     _**不可预测的区块提议者选择算法：**_ 一种通过改变区块提议者选择方法使其难以预测，从而增强对DoS攻击抵抗能力的算法。

●     _**VRank（验证者声誉评估框架）：**_ 一个用于评估验证者声誉的框架。

●     _**自主验证者罚金系统：**_ 该系统旨在对验证者的错误或恶意行为进行处罚。

●     _**系统交易和共识消息：**_ 通过区块提议者自动生成的“系统交易”，在合约中反映每个区块的最新共识信息。
...
在适用法律、法规和规则允许的最大范围内，Kaia DLT 基金会对因您接受或依赖本白皮书或其任何部分而产生的或与之相关的任何间接、特殊、附带、后果性或其他任何形式的损失（无论基于侵权、合同或其他原因）均不承担责任 （包括但不限于收入、收益或利润的损失，以及使用权或数据的损失），无论该等损失是否源于或与您接受或依赖本白皮书或其任何部分有关。

### 无陈述和保证

Kaia DLT 基金会未作出、亦不声称作出，并特此声明不作任何形式的陈述、保证或承诺，无论针对任何实体或个人，包括与本白皮书中所述任何信息的真实性、准确性和完整性相关的任何陈述、保证或承诺。

本白皮书中的任何内容均不构成、也不应被视为对 Kaia DLT 基金会未来表现或政策的承诺、声明或保证。基金会和/或 Kaia Governance 可随时根据本白皮书中介绍的最新路线图，自行决定更改所有信息、功能、发行、分发和架构。

此外，Kaia DLT 基金会声明，对于更新任何前瞻性陈述或公开宣布对这些前瞻性陈述的修订以反映未来的发展、事件或情况，概不承担任何责任，即使未来出现新信息或其他事件亦是如此。

请注意，本白皮书也只是一份进行中的工作，其中的信息仅截至本白皮书封面上的日期。 Kaia DLT 基金会保留不时更新白皮书的权利。

### 定标服务

如果您选择参与 KAIA 质押计划，向您提供的任何此类服务可能由 Kaia DLT 基金会负责实施——该基金会将在 Kaia 网络上担任交易验证者，并为您提供其私有节点以代您进行质押。任何适用的代表团奖励将由 Kaia 协议决定，并将记入您的帐户。

您确认并理解，Kaia DLT 基金会不保证您将获得任何委托奖励，且此类质押服务不构成定期存款产品或证券发行，后者属于《密克罗尼西亚联邦证券法》（FSMR）的监管范围。

由于协议解锁期或网络状况的影响，质押资产的提现可能会延迟，且 Kaia DLT 基金会无法保证网络贡献奖励的发放时间和金额。由于包括但不限于采用、投机、技术、安全和法规等因素，KAIA 主网和用于提供 KAIA 记账服务的相关接口存在固有风险，KAIA 代币和奖励市场可能会剧烈波动。您同意并确认，Kaia DLT 基金会对上述任何变量或风险均不承担任何责任。

### 不提供建议

本白皮书中的任何信息均不应被视为针对 Kaia DLT 基金会或 KAIA 的商业、法律、财务或税务建议。关于Kaia DLT基金会及其业务和运营，以及KAIA，您应咨询您自己的法律、财务、税务或其他专业顾问。您应该知道，您可能需要无限期地承担任何购买 KAIA 的财务风险。

### 对分发和传播的限制

任何司法管辖区的法律、监管要求和规则都可能禁止或限制分发或传播本白皮书或其中的任何部分。如果存在任何限制，您应自行了解并遵守适用于您持有本白皮书或其部分内容（视具体情况而定）的任何限制，相关费用由您自行承担，且Kaia DLT基金会对此不承担任何责任。已获得本白皮书，或已向其分发或传播本白皮书副本，或以其他方式拥有本白皮书的人员不得出于任何目的向任何其他人分发、复制或以其他方式传播本白皮书或其中包含的任何信息，也不得允许或导致发生上述行为。

### 风险和不确定性

有意购买 KAIA 的投资者，在购买 KAIA 之前，应仔细考虑并评估与 Kaia DLT 基金会及其业务和运营相关的所有风险和不确定性，以及本白皮书和《条款与条件》中载明的所有信息。
...
无论如何，Kaia DLT 基金会都不会因 KAIA 的任何发行或分发而产生任何费用。

\*\*不保证 KAIA 的功能或 KAIA 代币经济基础设施的交付或实现。如果上述任何风险和不确定性演变为实际事件，KAIA DLT 基金会的业务、 KAIA DLT 基金会的业务、财务状况、经营业绩及前景可能会受到重大不利影响。在这种情况下，您可能会失去 KAIA 的全部或部分价值。如果您已经购买了 KAIA，则不能退款或换货。

\*\*如果您对自己应采取的行动有任何疑问，应咨询您的法律、财务、税务或其他专业顾问。

---

[^1]: 具体数字经进一步审查和管理部门批准后可能会有变动。

[^2]: 为振兴 Klaytn 生态系统和吸纳开发人员而设立的基金，支出由管理部门批准后决定。

[^3]: 为运作现有的 Klaytn 基金会而设立的基金，其支出也是经管理部门批准后确定的。

[^4]: 为迎接 Klaytn 区块链的飞速发展而建立的储备金。

[^5]: 由于区块奖励等原因，Klaytn 和 Finschia 链的流通供应量可能会发生变化，直至链的合并。

[^6]: 未来的流通量只会因通货膨胀和新的销毁模式而发生变化。基金流通额的合并并不一定意味着清算，而且只能在管理批准的范围内透明地执行。
