...
本教程将逐步指导如何设置 ServiceChain 网络并将其连接到 Kaia Kairos 网络。您还将学习如何实现定期锚定和跨链价值转移。为了利用 ServiceChain 运行实际的区块链服务，我们将讲解高可用性、分层构建 ServiceChain 以及同级 ServiceChain 之间的价值转移。
