...
- 为父链/子链引入新的配置和 API，启用单独的气体限值设置。 (#1353)
  ...
  - 应用程序接口：subbridge_setParentBridgeOperatorGasLimit`、`subbridge_setChildBridgeOperatorGasLimit`、`subbridge_getParentBridgeOperatorGasLimit` 和`subbridge_getChildBridgeOperatorGasLimit\`。
