...
参见 [示例](https://github.com/kaiachain/kaia-sdk/tree/main/web3j-ext/web3j-ext/src/main/java/org/web3j/example)。
...
有关详细信息，请参阅 [Web3j kaia 扩展 GitHub 存储库](https://github.com/kaiachain/kaia-sdk/tree/main/web3j-ext)。