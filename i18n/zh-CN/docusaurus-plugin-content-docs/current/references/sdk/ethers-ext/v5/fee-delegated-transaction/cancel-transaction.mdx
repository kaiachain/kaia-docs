...
使用付费者的钱包将交易发送到区块链上。 Function `sendTransactionAsFeePayer` adds a signature with FeePayer’s private key to the sender’s signature and transmits it to the blockchain network.
