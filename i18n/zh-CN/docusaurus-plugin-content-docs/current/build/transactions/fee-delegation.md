...
| 属性                 | 类型                                                                                                                                                                          | 说明                                                                                                                                                                                                                |
| :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type               | uint8\(Go\)                                                                                                                                            | TxTypeFeeDelegatedValueTransfer 的类型。 必须为 0x09。                                                                                                                                                                    |
...
TxTypeFeeDelegatedValueTransferMemo 用于用户发送带有特定信息的 KAIA。 TxTypeFeeDelegatedValueTransferMemo 仅在 `to` 为外部所有账户时才被接受。 要将 KAIA 转入智能合约账户，请使用 [TxTypeFeeDelegatedSmartContractExecution](#txtypefeedelegatedsmartcontractexecution)。 该交易类型将进行以下更改。
...
| 属性                 | 说明                                                                                                                                                                          | 类型                                                                                                                                                                                                                | 示例值 |
| :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-- |
| type               | uint8\(Go\)                                                                                                                                            | TxTypeFeeDelegatedValueTransferMemo 的类型。 必须为 0x11。                                                                                                                                                                |     |
| nonce              | uint64 \(Go\)                                                                                                                                          | 用于唯一标识发件人交易的值。 如果一个发送方生成了两个具有相同 nonce 的交易，则只执行其中一个。                                                                                                                                                               |     |
| gasPrice           | \*big.Int （ Go\)                                                                                                                                           | 以 `kei` 为单位的气体单价，发件人将支付交易费。 交易费的计算公式为 `gas`\* `gasPrice`。 例如，如果交易消耗了 10 单位天然气，而 gasPrice 为 10^18，则交易费为 10 KAIA。 见 [Unit of KAIA](../../learn/token-economics/kaia-native-token.md#units-of-kaia). |     |
| gas                | uint64 \(Go\)                                                                                                                                          | 交易允许使用的最大燃气量。                                                                                                                                                                                                     |     |
| to                 | common.Address\(Go\)                                                                                                                   | 接收转账金额的账户地址。                                                                                                                                                                                                      |     |
...
TxTypeFeeDelegatedSmartContractDeploy 部署具有费用委托功能的智能合约。 该交易类型将进行以下更改。
...
| 属性                 | 类型                                                                                                                                                                          | 说明                                                                                                                                                                                                                |
| :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type               | uint8\(Go\)                                                                                                                                            | TxTypeFeeDelegatedSmartContractDeploy 的类型。 必须为 0x29。                                                                                                                                                              |
| nonce              | uint64 \(Go\)                                                                                                                                          | 用于唯一标识发件人交易的值。 如果一个发送方生成了两个具有相同 nonce 的交易，则只执行其中一个。                                                                                                                                                               |
| gasPrice           | \*big.Int （ Go\)                                                                                                                                           | 以 `kei` 为单位的气体单价，发件人将支付交易费。 交易费的计算公式为 `gas`\* `gasPrice`。 例如，如果交易消耗了 10 单位天然气，而 gasPrice 为 10^18，则交易费为 10 KAIA。 见 [Unit of KAIA](../../learn/token-economics/kaia-native-token.md#units-of-kaia). |
| gas                | uint64 \(Go\)                                                                                                                                          | 交易允许使用的最大燃气量。                                                                                                                                                                                                     |
...
TxTypeFeeDelegatedSmartContractExecution 使用 "输入 "中的给定数据执行智能合约。 费用由指定的缴费人支付。 只有当 `to` 是智能合约账户时，才接受 TxTypeFeeDelegatedSmartContractExecution。 要将 KAIA 转移到外部所有的账户，请使用 [TxTypeFeeDelegatedValueTransfer](#txtypefeedelegatedvaluetransfer)。 该交易类型将进行以下更改。
...
| 属性                 | 类型                                                                                                                                                                          | 说明                                                                                                                                                                                                                |
| :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type               | uint8\(Go\)                                                                                                                                            | TxTypeFeeDelegatedSmartContractExecution 的类型。 必须为 0x31。                                                                                                                                                           |
| nonce              | uint64 \(Go\)                                                                                                                                          | 用于唯一标识发件人交易的值。 如果一个发送方生成了两个具有相同 nonce 的交易，则只执行其中一个。                                                                                                                                                               |
| gasPrice           | \*big.Int （ Go\)                                                                                                                                           | 以 `kei` 为单位的气体单价，发件人将支付交易费。 交易费的计算公式为 `gas`\* `gasPrice`。 例如，如果交易消耗了 10 单位天然气，而 gasPrice 为 10^18，则交易费为 10 KAIA。 见 [Unit of KAIA](../../learn/token-economics/kaia-native-token.md#units-of-kaia). |
| gas                | uint64 \(Go\)                                                                                                                                          | 交易允许使用的最大燃气量。                                                                                                                                                                                                     |
...
| 属性                 | 类型                                                                                                                                                                          | 说明                                                                                                                                                                                                                  |
| :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| type               | uint8\(Go\)                                                                                                                                            | TxTypeAccountUpdate 的类型。 必须为 0x21。                                                                                                                                                                                  |
| nonce              | uint64 \(Go\)                                                                                                                                          | 用于唯一标识发件人交易的值。 如果一个发送方生成了两个具有相同 nonce 的交易，则只执行其中一个。                                                                                                                                                                 |
...
TxTypeFeeDelegatedCancel 取消执行事务池中具有相同 nonce 的事务。 更多详情，请参阅 [TxTypeCancel](./basic.md#txtypecancel)。

以下更改将适用于该交易类型。 1. 付费者的余额会减少交易费的金额。 2. 发送方的 nonce 增加一个。

### 属性<a id="attributes"></a>

| 属性                 | 类型                                                                                                                                                                          | 说明                                                                                                                                                                                                                |
| :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type               | uint8\(Go\)                                                                                                                                            | TxTypeCancel 的类型。 必须为 0x39。                                                                                                                                                                                       |
| nonce              | uint64 \(Go\)                                                                                                                                          | 用于唯一标识发件人交易的值。 如果一个发送方生成了两个具有相同 nonce 的交易，则只执行其中一个。                                                                                                                                                               |
| gasPrice           | \*big.Int （ Go\)                                                                                                                                           | 以 `kei` 为单位的气体单价，发件人将支付交易费。 交易费的计算公式为 `gas`\* `gasPrice`。 例如，如果交易消耗了 10 单位天然气，而 gasPrice 为 10^18，则交易费为 10 KAIA。 见 [Unit of KAIA](../../learn/token-economics/kaia-native-token.md#units-of-kaia). |
| gas                | uint64 \(Go\)                                                                                                                                          | 交易允许使用的最高交易费金额。                                                                                                                                                                                                   |
| from               | common.Address\(Go\)                                                                                                                   | 发件人地址。 详见 [签名验证](./transactions.md#signature-validation)。                                                                                                                                                         |
...
TxTypeFeeDelegatedChainDataAnchoring 是将服务链数据锚定到 Kaia 主链的收费委托事务。 服务链会定期向 Kaia 主链发送此类交易，以确保数据的安全性和可信度。 有关数据锚定的详细信息，请参阅 [锚定](../../nodes/service-chain/configure/anchoring.md)。 由于这也是一项收费委托交易，其交易费由收费者支付。 请注意，不允许通过 RPC 发送此事务。 目前，出于安全考虑，这种交易是通过私人 P2P 渠道执行的。 这笔交易不会改变 Kaia 区块链的状态，只是发送者的非ce 增加了一个。

### 属性<a id="attributes"></a>

| 属性                 | 类型                                                                                                                                                                          | 说明                                                                                                                                                                                                                |
| :----------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type               | uint8\(Go\)                                                                                                                                            | TxTypeFeeDelegatedChainDataAnchoring 的类型。 必须为 0x49。                                                                                                                                                               |
| nonce              | uint64 \(Go\)                                                                                                                                          | 用于唯一标识发件人交易的值。 如果一个发送方生成了两个具有相同 nonce 的交易，则只执行其中一个。                                                                                                                                                               |
| gasPrice           | \*big.Int （ Go\)                                                                                                                                           | 以 `kei` 为单位的气体单价，发件人将支付交易费。 交易费的计算公式为 `gas`\* `gasPrice`。 例如，如果交易消耗了 10 单位天然气，而 gasPrice 为 10^18，则交易费为 10 KAIA。 见 [Unit of KAIA](../../learn/token-economics/kaia-native-token.md#units-of-kaia). |
| gas                | uint64 \(Go\)                                                                                                                                          | 交易允许使用的最高交易费金额。                                                                                                                                                                                                   |
| from               | common.Address\(Go\)                                                                                                                   | 发件人地址。 详见 [签名验证](./transactions.md#signature-validation)。                                                                                                                                                         |
...
PublicKey.X 0x3a514176466fa815ed481ffad09110a2d344f6c9b78c1d14afc351c3a51be33d
PublicKey.Y 
SigHash 0x92e385b4a162170ee87b2b2e598f686b1d16f385d98ad626147305624abec0b3
Signature0xf845f84326a0afe41edc9cce1185ab9065ca7dbfb89ab5c7bde3602a659aa258324124644142a0317848698248ba7cc057b8f0dd19a27b52ef904d29cb72823100f1ed18ba2bb3
FeePayerPublicKey.X 0x327434d4cfc66ef8857d431419e9deebdc53a3e415edcc55382e2d417b8dd102
FeePayerPublicKey.Y 
SigHashFeePayer 
SenderTxHash 0x4f5c00ea8f6346baa7d4400dfefd72efa5ec219561ebcebed7be8a2b79d52bcd
  ...
  类型：          TxTypeFeeDelegatedChainDataAnchoring
  From：          0xa94f5374Fce5edBC8E2a8697C15331677e6EbF0B
  Nonce: 17
  GasPrice: 0x5d21dba00
  ...
  十六进制           
```
