...
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=1:2

```

---
Import necessary utils from **web3** and **eth_account**
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=3:7

```

---
Create a Web3 instance with the Klaytn Baobab testnet endpoint
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=9:11
...
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=14:15

```
---
Create the **contract instance** with its address and ABI
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=17:20
...
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=18

```

---
Set the contract abi. You can get the ABI after compiled in remix or solc compiler
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=19
...
<CH.Code>
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=22:23
...
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=26:29

```

---
**increment()** automatically makes the function call data and set it to the **data** field
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=26
...
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=31

```
---
Sign the transaction as **fee payer** with the fee delegator's key. You need to pass the fee payer's address as well.
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=33:38
...
<CH.Code>
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=40
...
<CH.Code>
```py contract_interaction_with_fee_delegation_klaytn_type.py focus=42:43
