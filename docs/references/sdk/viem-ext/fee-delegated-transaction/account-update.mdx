...
```js TxTypeFeeDelegatedAccountUpdate.js focus=4:17
...
```js TxTypeFeeDelegatedAccountUpdate.js focus=19:22
...
```js TxTypeFeeDelegatedAccountUpdate.js focus=23:32
...
<CH.Code>
```js TxTypeFeeDelegatedAccountUpdate.js focus=38:42
