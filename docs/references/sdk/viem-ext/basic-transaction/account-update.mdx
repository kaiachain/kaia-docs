...
```js TxTypeAccountUpdate.js focus=4:10
...
```js TxTypeAccountUpdate.js focus=13:16
...
<CH.Code>
```js TxTypeAccountUpdate.js focus=17:26
...
```js TxTypeAccountUpdate.js focus=28
...
<CH.Code>
```js TxTypeAccountUpdate.js focus=29:33
