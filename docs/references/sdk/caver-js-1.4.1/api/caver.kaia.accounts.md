...
`caver.kaia.accounts` contains functions to generate Kaia accounts and sign transactions and data.


## create <a id="create"></a>

```javascript
caver.kaia.accounts.create([entropy])
```
...
| signTransaction(tx [, callback]) | Function | The function to sign transactions. See [caver.kaia.accounts.signTransaction](#signtransaction). |
| sign(data) | Function | The function to sign transactions. See [caver.kaia.accounts.sign](#sign). |
| encrypt | Function | The function to encrypt private key with given password. |

**Example**

```javascript
> caver.kaia.accounts.create();
{
...
> caver.kaia.accounts.create(caver.utils.randomHex(32));
{ 
...
```javascript
caver.kaia.accounts.createWithAccountKey(address, accountKey)
```
...
**NOTE** `caver.kaia.accounts.createWithAccountKey` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
| getKaiaWalletKey | Function | The function to get [Kaia Wallet Key](../../../../learn/accounts.md#kaia-wallet-key-format). |

**Example**

```javascript
// Create an Account with AccountKeyPublic
> caver.kaia.accounts.createWithAccountKey('0x62ca8964610a9d447e1a64753a09fc8b3d40b405', '0x{private key}')
Account {
...
> caver.kaia.accounts.createWithAccountKey('0x62ca8964610a9d447e1a64753a09fc8b3d40b405', ['0x{private key}', '0x{private key}'])
Account {
    address: [Getter/Setter],
    accountKey: [Getter/Setter],
    privateKey: [Getter/Setter],
...
> caver.kaia.accounts.createWithAccountKey('0x62ca8964610a9d447e1a64753a09fc8b3d40b405', {
...
```javascript
caver.kaia.accounts.createWithAccountKeyPublic(address, accountKey)
```
Creates an instance of Account with AccountKeyPublic.

**NOTE** `caver.kaia.accounts.createWithAccountKeyPublic` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
`Object` - An Account instance, see [caver.kaia.accounts.createWithAccountKey](#createwithaccountkey).

**Example**

```javascript
> caver.kaia.accounts.createWithAccountKeyPublic('0x62ca8964610a9d447e1a64753a09fc8b3d40b405', '0x{private key}')
Account {
    address: [Getter/Setter],
    accountKey: [Getter/Setter],
    privateKey: [Getter/Setter],
...
```javascript
caver.kaia.accounts.createWithAccountKeyMultiSig(address, accountKey)
```
Creates an instance of Account with AccountKeyMultiSig.

**NOTE** `caver.kaia.accounts.createWithAccountKeyMultiSig` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
```javascript
> caver.kaia.accounts.createWithAccountKeyMultiSig('0x62ca8964610a9d447e1a64753a09fc8b3d40b405', ['0x{private key}', '0x{private key}'])
Account {
    address: [Getter/Setter],
    accountKey: [Getter/Setter],
    privateKey: [Getter/Setter],
...
```javascript
caver.kaia.accounts.createWithAccountKeyRoleBased(address, accountKey)
```
Creates an instance of Account with AccountKeyRoleBased.

**NOTE** `caver.kaia.accounts.createWithAccountKeyRoleBased` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
```javascript
> caver.kaia.accounts.createWithAccountKeyRoleBased('0x62ca8964610a9d447e1a64753a09fc8b3d40b405', {
    transactionKey: ['0x{private key}', '0x{private key}', '0x{private key}'],
    updateKey: ['0x{private key}', '0x{private key}', '0x{private key}'],
    feePayerKey: ['0x{private key}', '0x{private key}', '0x{private key}']
})
...
```javascript
caver.kaia.accounts.createAccountKey(key)
```
...
**NOTE** `caver.kaia.accounts.createAccountKey` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
> caver.kaia.accounts.createAccountKey('0x{private key}')
AccountKeyPublic {
    _key: '0x{private key}'
}

// Create an AccountKeyMultiSig
> caver.kaia.accounts.createAccountKey(['0x{private key}', '0x{private key}'])
AccountKeyMultiSig {
    _keys: [ 
      '0x{private key}',
      '0x{private key}'
...
> caver.kaia.accounts.createAccountKey({
...
```javascript
caver.kaia.accounts.createAccountKeyPublic(key)
```
Creates an instance of `AccountKeyPublic` with the given private key string.

**NOTE** `caver.kaia.accounts.createAccountKeyPublic` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
`Object` - An AccountKeyPublic instance, see [caver.kaia.accounts.createAccountKey](#createaccountkey).


**Example**

```javascript
> caver.kaia.accounts.createAccountKeyPublic('0x{private key}')
AccountKeyPublic {
    _key: '0x{private key}'
}
```
...
```javascript
caver.kaia.accounts.createAccountKeyMultiSig(keys)
```
Creates an instance of `AccountKeyMultiSig` with the given multiple private keys.

**NOTE** `caver.kaia.accounts.createAccountKeyMultiSig` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
`Object` - An AccountKeyMultiSig instance, see [caver.kaia.accounts.createAccountKey](#createaccountkey).


**Example**

```javascript
> caver.kaia.accounts.createAccountKeyMultiSig(['0x{private key}', '0x{private key}'])
AccountKeyMultiSig {
    _keys: [ 
      '0x{private key}',
      '0x{private key}'
...
```javascript
caver.kaia.accounts.createAccountKeyRoleBased(keyObject)
```
Creates an instance of `AccountKeyRoleBased` with the given keys associated with each role.

**NOTE** `caver.kaia.accounts.createAccountKeyRoleBased` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
`Object` - An AccountKeyRoleBased instance, see [caver.kaia.accounts.createAccountKey](#createaccountkey).


**Example**

```javascript
> caver.kaia.accounts.createAccountKeyRoleBased({
    transactionKey: '0x{private key}',
    updateKey: ['0x{private key}', '0x{private key}'],
    feePayerKey: '0x{private key}'
})
...
```javascript
caver.kaia.accounts.accountKeyToPublicKey(accountKey)
```
This function converts the private key of AccountKey to public key.

**NOTE** `caver.kaia.accounts.accountKeyToPublicKey` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
> caver.kaia.accounts.accountKeyToPublicKey('0x{private key}')
...
> caver.kaia.accounts.accountKeyToPublicKey(['0x{private key}', '0x{private key}'])
[
    '0x67f20d1198abcdc036a4d8f3ea0cf837527716c90f71d0b0410dfe3e1b405eded9ea818eedd5e8ad79658b2cdf4862ab0956a6f7fd0a4886afe6110b2e9803a4',
...
> caver.kaia.accounts.accountKeyToPublicKey({transactionKey: ['0x{private key}', '0x{private key}'], updateKey: '0x{private key}', feePayerKey: ['0x{private key}', '0x{private key}']})
{ 
    transactionKey: [
        '0x67f20d1198abcdc036a4d8f3ea0cf837527716c90f71d0b0410dfe3e1b405eded9ea818eedd5e8ad79658b2cdf4862ab0956a6f7fd0a4886afe6110b2e9803a4',
        '0x7c5415f99628618b3fe78e14606c83a22488769b3361e3758c7c98a204a23b615cf07af65490895d70a7b7e7e885fc2f597d65ea69ed586c7ae7cb0241656036'
...
```javascript
caver.kaia.accounts.privateKeyToAccount(privateKey)
```
...
```javascript
> caver.kaia.accounts.privateKeyToAccount('0x{private key}');
{ 
    address: '0x62ca8964610a9d447e1a64753a09fc8b3d40b405',
    privateKey: '0x{private key}',
    signTransaction: [Function: signTransaction],
...
```javascript
caver.kaia.accounts.privateKeyToPublicKey(privateKey)
```
...
```javascript
> caver.kaia.accounts.privateKeyToPublicKey('0x{private key}')
...
```javascript
caver.kaia.accounts.createAccountForUpdate(address, accountKey, options)
```
...
The accountKey parameter of caver.kaia.accounts.createAccountForUpdate must be a private key. 

You can create an AccountForUpdate instance using the public key with [caver.kaia.accounts.createAccountForUpdateWithPublicKey](#createaccountforupdatewithpublickey). 

You can also use [caver.kaia.accounts.createAccountForUpdateWithLegacyKey](#createaccountforupdatewithlegacykey) to create an AccountForUpdate instance for updating to [AccountKeyLegacy](../../../../learn/accounts.md#accountkeylegacy), and [caver.kaia.accounts.createAccountForUpdateWithFailKey](#createaccountforupdatewithfailkey) to create an AccountForUpdate instance for updating to [AccountKeyFail](../../../../learn/accounts.md#accountkeyfail).

**NOTE** `caver.kaia.accounts.createAccountForUpdate` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
> caver.kaia.accounts.createAccountForUpdate('0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef', '0x{private key}')
AccountForUpdate {
...
> caver.kaia.accounts.createAccountForUpdate('0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef', ['0x{private key}', '0x{private key}'], { threshold: 2, weight: [1,1] })
AccountForUpdate {
    address: '0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef',
    keyForUpdate: {
        multisig: {
...
> caver.kaia.accounts.createAccountForUpdate('0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef', { transactionKey: '0x{private key}', updateKey: ['0x{private key}', '0x{private key}'], feePayerKey: '0x{private key}' }, { updateKey: { threshold: 2, weight: [1,1] } })
AccountForUpdate {
    address: '0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef',
    keyForUpdate: { 
        roleTransactionKey: { 
...
> caver.kaia.accounts.createAccountForUpdate('0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef', { transactionKey: 'legacyKey', updateKey: 'failKey' })
AccountForUpdate {
    address: '0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef',
    keyForUpdate: {
...
```javascript
caver.kaia.accounts.createAccountForUpdateWithPublicKey(address, keyForUpdate, options)
```
Creates an instance of `AccountForUpdate` with the public key of the new key to update.

`AccountForUpdate` can be used in the account update transaction object (`ACCOUNT_UPDATE`, `FEE_DELEGATED_ACCOUNT_UPDATE`, or `FEE_DELEGATED_ACCOUNT_UPDATE_WITH_RATIO`) as a `key`. If you want to know how to use `AccountForUpdate` in the transaction, see [Account update with AccountForUpdate](../get-started-1.4.1.md#account-update-with-accountforupdate).

**NOTE** `caver.kaia.accounts.createAccountForUpdateWithPublicKey` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
`Object` - An AccountForUpdate instance, see [caver.kaia.accounts.createAccountForUpdate](#createaccountforupdate).
...
```javascript
// Create AccountForUpdate for AccountKeyPublic
> caver.kaia.accounts.createAccountForUpdateWithPublicKey('0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef', '0x24c32ee4f908ceed89e7501de2980fcb1d2add69080d3921f86c49de863eb2d507e24d9aaf91328b7f7cef2a94b538cb33b3f8cdd64925855ce0a4bf6e11f3db')
AccountForUpdate {
    address: '0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef',
    keyForUpdate: { 
        publicKey: '0x24c32ee4f908ceed89e7501de2980fcb1d2add69080d3921f86c49de863eb2d507e24d9aaf91328b7f7cef2a94b538cb33b3f8cdd64925855ce0a4bf6e11f3db'
...
```javascript
caver.kaia.accounts.createAccountForUpdateWithLegacyKey(address)
```
...
**NOTE** `caver.kaia.accounts.createAccountForUpdateWithLegacyKey` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
> caver.kaia.accounts.createAccountForUpdateWithLegacyKey('0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef')
AccountForUpdate {
    address: '0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef',
...
```javascript
caver.kaia.accounts.createAccountForUpdateWithFailKey(address)
```
...
**NOTE** `caver.kaia.accounts.createAccountForUpdateWithFailKey` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
> caver.kaia.accounts.createAccountForUpdateWithFailKey('0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef')
AccountForUpdate {
    address: '0x5B4EF8e2417DdE1b9B80BcfC35d1bfeF3D7234ef',
...
| rawTransaction | String | The RLP encoded transaction, ready to be send using caver.kaia.sendSignedTransaction. |
...
```javascript
caver.kaia.accounts.signTransactionWithHash(txHash, privateKeys [, chainId] [, callback])
```

Signs a Kaia transaction with the given transaction hash and private key.

**NOTE** `caver.kaia.accounts.signTransactionWithHash` is supported since caver-js [v1.3.2-rc.2](https://www.npmjs.com/package/caver-js/v/1.3.2-rc.2).
...
| chainId | String \| Number | (optional) The chainId of the chain. If omitted, it will be set by caver-js via callling [caver.kaia.getChainId](./caver.kaia/config.md#getchainid) |
| callback | Function | (optional) Optional callback, returns an error object as the first parameter and the result as the second. |
...
> caver.kaia.accounts.signTransactionWithHash('0x583d887614e1ce674c05fcd050a661f0631c23ed1f95fa43fefcc25e6383bca1', '0x{priavte key}', '0x3e9').then(console.log)
[
    {
        V: '0x07f5',
...
> caver.kaia.accounts.signTransactionWithHash('0x583d887614e1ce674c05fcd050a661f0631c23ed1f95fa43fefcc25e6383bca1', '0x{priavte key}').then(console.log)
[
    {
        V: '0x07f5',
        R: '0x66eb2dbb90295b7541de72f2d34002bac3f00a94501453b310b25a0da62446a5',
...
> caver.kaia.accounts.signTransactionWithHash('0x583d887614e1ce674c05fcd050a661f0631c23ed1f95fa43fefcc25e6383bca1', ['0x{priavte key}', '0x{priavte key}'], '0x3e9').then(console.log)
[
    {
        V: '0x07f5',
        R: '0x66eb2dbb90295b7541de72f2d34002bac3f00a94501453b310b25a0da62446a5',
...
> caver.kaia.accounts.signTransactionWithHash('0x583d887614e1ce674c05fcd050a661f0631c23ed1f95fa43fefcc25e6383bca1', ['0x{priavte key}', '0x{priavte key}']).then(console.log)
[
    {
        V: '0x07f5',
        R: '0x66eb2dbb90295b7541de72f2d34002bac3f00a94501453b310b25a0da62446a5',
...
```javascript
caver.kaia.accounts.feePayerSignTransaction(tx, feePayerAddress [, privateKey] [, callback])
```
...
| r | String | ECDSA signature r. |
| s | String | ECDSA signature s. |
| rawTransaction | String | The RLP encoded transaction, ready to send using caver.kaia.sendSignedTransaction. |
| txHash | 32-byte String | Hash of the transaction. |
| senderTxHash | 32-byte String | Hash of a transaction that is signed only by the sender. See [SenderTxHash](../../../../learn/transactions/transactions.md#sendertxhash) |
...
> caver.kaia.accounts.feePayerSignTransaction({
...
> caver.kaia.accounts.feePayerSignTransaction('', '0x2e4351e950d8d43444ac789cc9e87ba35340ad52', '0x90300d268bb2bad69f5b24e2ac1409a9416cc814254b356ce96b3f75c4364716').then(console.log)
{
    messageHash: '0x4cc0a423199d374d412cd3f92777a8f82bfc47b701d0df1f82b0d932802c955e',
    v: '0x4e44',
    r: '0x2a2cdce5dd2fea8e717f94457700ca9cfa43fd5b09b57b1c8dc9cd2e73ac2730',
...
```javascript
caver.kaia.accounts.recoverTransaction(rawTransaction)
```
...
```js
> caver.kaia.accounts.recoverTransaction('0xf86180808401ef364594f0109fc8df283027b6285cc889f5aa624eac1f5580801ca031573280d608f75137e33fc14655f097867d691d5c4c44ebe5ae186070ac3d5ea0524410802cdc025034daefcdfa08e7d2ee3f0b9d9ae184b2001fe0aff07603d9');
...
```javascript
caver.kaia.accounts.hashMessage(message)
```

Hashes the given message in order for it to be passed to [caver.kaia.accounts.recover](#recover).
...
```javascript
> caver.kaia.accounts.hashMessage("Hello World")
'0xf334bf277b674260e85f1a3d2565d76463d63d29549ef4fa6d6833207576b5ba'

// the below results in the same hash
> caver.kaia.accounts.hashMessage(caver.utils.utf8ToHex("Hello World"))
'0xf334bf277b674260e85f1a3d2565d76463d63d29549ef4fa6d6833207576b5ba'
```
...
```javascript
caver.kaia.accounts.sign(data, privateKey)
```
...
```javascript
> caver.kaia.accounts.sign('Some data', '0x{private key}');
{
    message: 'Some data',
...
```javascript
caver.kaia.accounts.recover(signatureObject)
caver.kaia.accounts.recover(message, signature [, preFixed])
caver.kaia.accounts.recover(message, v, r, s [, preFixed])
```
...
// message, signature
> caver.kaia.accounts.recover('Some data', '0x4a57bcff1637346a4323a67acd7a478514d9f00576f42942d50a5ca0e4b0342b5914e19a8ebc10ce1450b00a3b9c1bf0ce01909bca3ffdead1aa3a791a97b5ac1b');
'0x2c7536E3605D9C16a7a3D7b1898e529396a65c23'

// message, v, r, s
> caver.kaia.accounts.recover('Some data', '0x1b', '0x4a57bcff1637346a4323a67acd7a478514d9f00576f42942d50a5ca0e4b0342b', '0x5914e19a8ebc10ce1450b00a3b9c1bf0ce01909bca3ffdead1aa3a791a97b5ac');
'0x2c7536E3605D9C16a7a3D7b1898e529396a65c23'
```
...
```javascript
caver.kaia.accounts.combineSignatures(rawTransactions)
```
...
| Name | Type | Description |
| --- | --- | --- |
| rawTransaction | String | An RLP encoded transaction, ready to send using caver.kaia.sendSignedTransaction. |
| txHash | 32-byte String | Hash of the transaction. |
| senderTxHash | 32-byte String | Hash of a transaction that is signed only by the sender. See [SenderTxHash](../../../../learn/transactions/transactions.md#sendertxhash) |
...
```javascript
> caver.kaia.accounts.combineSignatures([
...
```javascript
caver.kaia.accounts.getRawTransactionWithSignatures(tx [, callback])
```
...
| Name | Type | Description |
| --- | --- | --- |
| tx | Object | A transaction object that includes signatures and feePayerSignatures. The properties of a transaction object varies depending on the transaction type. For the description of each transaction type, see [caver.kaia.sendTransaction](./caver.kaia/transaction/transaction.md#sendtransaction). |
...
> caver.kaia.accounts.getRawTransactionWithSignatures({
...
```javascript
caver.kaia.accounts.encrypt(encryptTarget, password [, options])
```
...
**NOTE** Since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0), `caver.kaia.accounts.encrypt` encrypts using the keystore v4 standard to encrypt various AccountKey types (AccountKeyPublic, AccountKeyMultiSig, AccountKeyRoleBased). If you want to encrypt an account using keystore v3, please use [caver.kaia.accounts.encryptV3](#encryptv3).
...
1. Use the [KaiaWalletKey](../../../../learn/accounts.md#kaia-wallet-key-format) format with the privateKey parameter.
...
> caver.kaia.accounts.encrypt('0x{private key}', 'test')
{
    version: 4,
...
> caver.kaia.accounts.encrypt(['0x{private key}', '0x{private key}'], 'test', { address: '0xe1d711ee2ac2dfec5b1e6ea583c8270b7575702a' })
{
    version: 4,
...
> caver.kaia.accounts.encrypt({ transactionKey: ['0x{private key}', '0x{private key}'], updateKey: '0x{private key}', feePayerKey: '0x{private key}'}, 'test', { address: '0xe1d711ee2ac2dfec5b1e6ea583c8270b7575702a' })
{
    version: 4,
...
> caver.kaia.accounts.encrypt('0x{private key}0x{type}0x{address in hex}', 'test')
{
    version: 4,
...
> caver.kaia.accounts.encrypt('0x{private key}', 'test', { address: '0x7d46813010aee975946d6ee9c7fb887eef6b318d' })
{
    version: 4,
...
```javascript
caver.kaia.accounts.encryptV3(encryptTarget, password [, options])
```
Encrypts an account to the Kaia keystore v3 standard. 

**NOTE** `caver.kaia.accounts.encryptV3` is supported since caver-js [v1.3.2-rc.1](https://www.npmjs.com/package/caver-js/v/1.3.2-rc.1).
...
**NOTE**: There are two ways to encrypt the private key when an account has a decoupled private key from the address.
1. Use the [KaiaWalletKey](../../../../learn/accounts.md#kaia-wallet-key-format) as `encryptTarget` parameter.
...
> caver.kaia.accounts.encryptV3('0x{private key}', 'test!')
{
    version: 3,
...
> caver.kaia.accounts.encryptV3('0x{private key}0x{type}0x{address in hex}', 'test!')
{
    version: 3,
    id: 'ff07b774-b572-4c76-a925-9e7650fb0488',
    address: '0x4abe737d3c57dce9152988c714e9e4b341647650',
...
> caver.kaia.accounts.encryptV3('0x{private key}', 'test!', { address: '0x4abe737d3c57dce9152988c714e9e4b341647650' })
{
    version: 3,
    id: 'ff07b774-b572-4c76-a925-9e7650fb0488',
    address: '0x4abe737d3c57dce9152988c714e9e4b341647650',
...
```javascript
caver.kaia.accounts.decrypt(keystoreJsonV3, password)
```
Decrypts a keystore v3 or v4 JSON and returns the decrypted account object.

**NOTE** Since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0), `caver.kaia.accounts.decrypt` can decrypt the keystore v4.
...
```javascript
caver.kaia.accounts.isDecoupled(key, address)
```
...
| Name | Type | Description |
| --- | --- | --- |
| key | String | Key to determine if decoupled from address. Key can be a 32-byte string private key or a [KaiaWalletKey](../../../../learn/accounts.md#kaia-wallet-key-format). |
...
```javascript
> caver.kaia.accounts.isDecoupled('0x{private key}', '0x{address in hex}')
true

> caver.kaia.accounts.isDecoupled('0x{private key}0x{type}0x{address in hex}')
true

> caver.kaia.accounts.isDecoupled('0x{private key}')
false
...
```javascript
caver.kaia.accounts.getLegacyAccount(key)
```
...
| Name | Type | Description |
| --- | --- | --- |
| key | String | The parameter used to get an account that has a legacy account key. Key can be a 32-byte string private key or a [KaiaWalletKey](../../../../learn/accounts.md#kaia-wallet-key-format). In KaiaWalletKey, only the portion corresponding to the private key is used. |
...
> caver.kaia.accounts.getLegacyAccount('0x{private key}')
{ 
    legacyAccount: { 
...
> caver.kaia.accounts.getLegacyAccount('0x{private key}0x{type}0x{address in hex}')
{ 
    legacyAccount: { 
        address: '0xE26D5d4983eD62A99D7D4Bc0cE0e784782fF6B27',
        privateKey: '0x{private key}'
...
```javascript
caver.kaia.accounts.wallet
```
Contains an in-memory wallet with multiple accounts.  These accounts can be used
when using [caver.kaia.sendTransaction](./caver.kaia/transaction/transaction.md#sendtransaction).
...
```javascript
caver.kaia.accounts.wallet.create([numberOfAccounts] [, entropy])
```
...
```javascript
> caver.kaia.accounts.wallet.create(1, 'entropy');
Wallet {
  '0': { ... },
  _accounts: Accounts { ... },
  length: 1,
...
```javascript
caver.kaia.accounts.wallet.add(account [, targetAddress])
```
Adds an account using a private key or account object to the wallet.

**NOTE**: If the same address exists inside the wallet, an error is returned. 
If you want to change the private key associated to an account in the wallet, please use [caver.kaia.accounts.wallet.updatePrivateKey](#wallet-updateprivatekey).
...
| Name | Type | Description |
| --- | --- | --- |
| account | String \| Object | A private key or account object created with [caver.kaia.accounts.create](#create). |
...
One is a raw private key format of a 32-byte string type and the other is the [KaiaWalletKey](../../../../learn/accounts.md#kaia-wallet-key-format).
...
```javascript
> caver.kaia.accounts.wallet.add('0x{private key}');
{ 
...
> caver.kaia.accounts.wallet.add('0x{private key}', '0xfe9157e180c8f4c229e88d0c1763a746db8b19b4');
{ 
...
> caver.kaia.accounts.wallet.add({
      privateKey: '0x{private key}',
...
> caver.kaia.accounts.wallet.add('0x{private key}0x{type}0x{address in hex}');
{ 
...
```javascript
caver.kaia.accounts.wallet.getAccount(addressOrIndex)
```
Returns the account corresponding to the address in `caver.kaia.accounts.wallet`.
...
```javascript
> caver.kaia.accounts.wallet.getAccount('0x{address in hex}')
Account {
    address: [Getter/Setter],
    accountKey: [Getter/Setter],
    privateKey: [Getter/Setter],
...
> caver.kaia.accounts.wallet.getAccount(0)
Account {
    address: [Getter/Setter],
    accountKey: [Getter/Setter],
    privateKey: [Getter/Setter],
...
```javascript
caver.kaia.accounts.wallet.remove(account)
```
...
> caver.kaia.accounts.wallet.remove('0xce3bda34a14415f3bc2bcd5e61c48043857a6451');
true

> caver.kaia.accounts.wallet.remove(3);
false
```
...
```javascript
caver.kaia.accounts.wallet.clear()
```
...
```javascript
caver.kaia.accounts.wallet.encrypt(password)
```
...
```javascript
> caver.kaia.accounts.wallet.encrypt('test');
[ 
    { 
        version: 3,
...
```javascript
caver.kaia.accounts.wallet.decrypt(keystoreArray, password)
```
...
```javascript
> caver.kaia.accounts.wallet.decrypt([ 
    { 
        version: 3,
        id: '2b334f59-a0bc-446c-9f25-c934e432e832',
        address: '0x57629b4a9dc137f15400a3d96ab9e1e57b7f57c7',
...
```javascript
caver.kaia.accounts.wallet.getKaiaWalletKey(index)
caver.kaia.accounts.wallet.getKaiaWalletKey(address)
```
...
> caver.kaia.accounts.wallet.getKaiaWalletKey(0)
'0x{private key}0x{type}0x{address in hex}'

// With index of wallet list
> caver.kaia.accounts.wallet.getKaiaWalletKey(1)
'0x{private key}0x{type}0x{address in hex}'

// With an address in hexadecimal
> caver.kaia.accounts.wallet.getKaiaWalletKey('0xa9d40b07a6d06e7b7af6cf9a17fb107c9fc7fe58')
'0x{private key}0x{type}0x{address in hex}'

// If the given account does not exist in the caver-js wallet, returns an error.
> caver.kaia.accounts.wallet.getKaiaWalletKey('0x35170d0c774b8c80e9f802a7af6d0497e621c215')
...
```javascript
> caver.kaia.accounts.wallet.updatePrivateKey('0x{private key}', '0xf2e2565629c7763dc0b595e8e531a31371a95f95');
Account {
    address: [Getter/Setter],
    accountKey: [Getter/Setter],
    privateKey: [Getter/Setter],
...
```javascript
caver.kaia.accounts.wallet.updateAccountKey(address, accountKey)
```
...
**NOTE** `caver.kaia.accounts.wallet.updateAccountKey` is supported since caver-js [v1.2.0](https://www.npmjs.com/package/caver-js/v/1.2.0).
...
> caver.kaia.accounts.wallet.updateAccountKey('0xf2e2565629c7763dc0b595e8e531a31371a95f95', '0x{private key}')
Account {
    address: [Getter/Setter],
    accountKey: [Getter/Setter],
    privateKey: [Getter/Setter],
...
> caver.kaia.accounts.wallet.updateAccountKey('0xf2e2565629c7763dc0b595e8e531a31371a95f95', ['0x{private key}', '0x{private key}', '0x{private key}'])
Account {
    address: [Getter/Setter],
    accountKey: [Getter/Setter],
    privateKey: [Getter/Setter],
...
> caver.kaia.accounts.wallet.updateAccountKey('0x2F66043C35e2389dA0B5401c3C592b2002d60bAc', {
