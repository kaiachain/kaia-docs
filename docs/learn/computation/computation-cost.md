...
### 1. Limiting the gas limit of a transaction (not in Kaia)
...
We modelled the computation cost of each EVM opcode based on its actual execution time and limit the sum of computation cost of a transaction. With this approach, we eliminate other factors and only count the normalized execution time unit, and nodes can reach a consensus as well. The computation cost limit was 100,000,000 (OpcodeComputationCostLimit), but as CPU computing performance has increased, the limit has been raised to 150,000,000 (OpcodeComputationCostLimitCancun) after Cancun EVM hardfork. This limit value is determined by the platform, so the developers should be aware of the computation cost of a transaction. To calculate the computation cost of a transaction, Kaia provides [kaia_estimateComputationCost](../../../references/json-rpc/kaia/estimate-computation-cost). The usage is almost the same as [kaia_estimateGas](../../../references/json-rpc/kaia/estimate-gas).
...
| 0x04    | dataCopy              | 0                                                                                                                                   | 
| 0x05    | bigModExp             | see the code [here](https://github.com/kaiachain/kaia/blob/45e53b7ff01cb3febefbebbb16c0456718b49842/blockchain/vm/contracts.go#L586) |
| 0x06    | bn256Add              | 8,000                                                                                                                               | 
...
| 0x0c    | bls12381G1MultiExp    | see the code [here](https://github.com/kaiachain/kaia/blob/45e53b7ff01cb3febefbebbb16c0456718b49842/blockchain/vm/contracts.go#L1155) |
| 0x0d    | bls12381G2Add         | 30,000 |
| 0x0e    | bls12381G2MultiExp    | see the code [here](https://github.com/kaiachain/kaia/blob/45e53b7ff01cb3febefbebbb16c0456718b49842/blockchain/vm/contracts.go#L1261) |
| 0x0f    | bls12381Pairing       | numOfPairings(input) * 1,630,000 + 1,885,000 |
| 0x10    | bls12381MapG1         | 275,000 |
| 0x11    | bls12381MapG2         | 1,190,000 |
| 0x100   | p256Verify            | 235,000 |

## Hardfork Changes <a id="hardfork-changes"></a>
| Hardfork     | New items                                                                                                                             | Changes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|--------------|:--------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Osaka EVM  | CLZ (0x1e) opcode<br/>p256Verify (0x100) precompiled contract | modExp (0x05) precompiled contract <br/>use new gas calculation logic. <br/>Computation cost also affected. <br/>Become more accurate. |
| Prague EVM | bls12381G1Add (0x0b) precompiled contract<br/>bls12381G1MultiExp (0x0c) precompiled contract<br/>bls12381G2Add (0x0d) precompiled contract<br/>bls12381G2MultiExp (0x0e) precompiled contract<br/>bls12381Pairing (0x0f) precompiled contract<br/>bls12381MapG1 (0x10) precompiled contract<br/>bls12381MapG2 (0x11) precompiled contract<br/> | |
| Cancun EVM   | BLOBBASEFEE (0x49) opcode<br/>BLOBHASH (0x50) opcode<br/>TSTORE (0x5c) opcode<br/>TLOAD (0x5d) opcode<br/>MCOPY (0x5e) opcode<br/>kzg (0x0a) precompiled contract | increase the computation cost limit <br/>from 100,000,000 to 150,000,000<br/><br/>reduce the computation cost of some opcodes <br/>due to cpu performance increase<br/>-Sdiv (0x05): 739 -> 360<br/>-Mod (0x06): 812 -> 320<br/>-Addmod (0x08): 1410 -> 360<br/>-Mulmod (0x09): 1760 -> 700<br/>-Exp (0x0A): 5000 -> 720<br/>-Sha3 (0x20): 2465 -> 560<br/>-Mstore8 (0x53): 5142 -> 230<br/>-Log1, Log2, Log3, Log4 (0xA1-0xA4): 1000 -> 500<br/><br/>increase the computation cost of some opcodes <br/>due to increased database size<br/>-SLOAD (0x54): 835 -> 2550<br/>-SSTORE (0x55): 1548 -> 2510 |
