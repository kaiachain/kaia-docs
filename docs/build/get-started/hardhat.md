...
:::note
This guide uses Hardhat v2. If you prefer to use Hardhat v3, please refer to the [setup guide](../../_shared/create-and-manage-wallets-securely.md#33-recipe-securely-managing-accounts-in-a-hardhat-project) for configuration instructions
:::
