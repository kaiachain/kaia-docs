...
:::note
The Kaia Eliza Plugin uses the Kaia Agent Kit under the hood. This means all onchain actions, like sending tokens or checking balances, are powered by the Kaia Agent Kit’s secure and reliable tools.
:::
