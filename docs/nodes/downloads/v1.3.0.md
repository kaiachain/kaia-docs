...
## Release Notes for Kaia v1.3.0

## Notice <a id="notice"></a>
- Official go version for kaia v1.3.0 is go-1.13.3 to address security issues. We recommend go-1.13.3 or higher version when building klaytn.

### New features <a id="new-features"></a>
- Signing of Kaia transaction types through RPC APIs (klay_signTransaction and klay_signTransactionAsFeePayer).
...
- New JSON-RPC APIs
  - kaia.encodeAccountKey
  - kaia.decodeAccountKey
  - kaia.sendTransactionAsFeePayer
